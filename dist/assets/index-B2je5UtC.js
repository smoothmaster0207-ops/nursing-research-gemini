...
Ⅴ. 期待される成果
看護師の業務負担を最適化しつつ、患者の安全な在宅移行を実現するためのエビデンスを提示する。`},qe="https://gemini.google.com/app";async function Le(e){try{return await navigator.clipboard.writeText(e),!0}catch{const s=document.createElement("textarea");s.value=e,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select();try{return document.execCommand("copy"),document.body.removeChild(s),!0}catch{return document.body.removeChild(s),!1}}}function ke(){window.open(qe,"_blank","noopener,noreferrer")}function E(e){const{prompt:t,containerId:s,label:r="AI回答",expectJson:i=!1,placeholder:n="Geminiからの回答をここに貼り付けてください..."}=e;return`
...
...(続き)`:""}</div>
    ...
    `}function T(e,t,s,r=!1){const i=e.querySelector(".gemini-copy-btn"),n=e.querySelector(".gemini-open-btn"),o=e.querySelector(".gemini-response-input"),l=e.querySelector(".gemini-submit-btn"),c=e.querySelector(".gemini-copy-feedback");i&&i.addEventListener("click",async()=>{const d=await Le(t);c&&(c.textContent=d?"✅ コピーしました！":"❌ コピーに失敗しました",c.style.opacity="1",setTimeout(()=>{c.style.opacity="0"},2500))}),n&&n.addEventListener("click",()=>{ke()}),o&&l&&(o.addEventListener("input",()=>{l.disabled=!o.value.trim()}),l.addEventListener("click",()=>{const d=o.value.trim();if(d)if(r)try{const u=d.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim(),p=JSON.parse(u);s(p,d)}catch{s(null,d)}else s(d,d)}))}function M(){return a.get("demoMode")}function Ee(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Te(e){const t=a.get("seed"),s=t.refinedResult||null;e.innerHTML=`
    <div class="fade-in">
...
${e}`,s=document.querySelector("#geminiChatUI");if(s){if(M()){Ae();return}s.innerHTML=E({prompt:t,containerId:"geminiChat",label:"ブレインストーミング（研究の種の整理）",expectJson:!1,placeholder:"Geminiが出力した「📋 研究の骨子」をここにコピー＆ペーストしてください..."}),T(s,t,r=>{if(r){const i=r||"";let n=Ie(i);if(n||(n=Oe(i)),n){a.set("seed.refinedResult",n);const o=document.querySelector("#refinedResultArea");o&&(o.classList.remove("hidden"),o.innerHTML=D(n),N(o,n),o.scrollIntoView({behavior:"smooth"})),$("Theme",(n.theme||n.rq||"").substring(0,60)),$("RQ",n.rq||""),s.innerHTML=`
        ...
        `}else alert("骨子の内容を判読できませんでした。Geminiが出力した「📋 研究の骨子」の部分をそのまま貼り付けてください。")}})}}function Ae(e){const t=JSON.parse(k.rqOverview);a.set("seed.refinedResult",t);const s=document.querySelector("#geminiChatUI");s&&(s.innerHTML=`
      <div class="card" style="background: #f0fdf4; border: 1px solid #86efac; text-align: center; padding: var(--space-4);">
        <p style="color: #166534; font-weight: 600; margin: 0;">✅ デモモード：研究の骨子を自動生成しました。下の内容を確認してください。</p>
      </div>
    `);const r=document.querySelector("#refinedResultArea");r&&(r.classList.remove("hidden"),r.innerHTML=D(t),N(r,t)),$("Theme",(t.theme||t.rq||"").substring(0,60)),$("RQ",t.rq||"")}function Ie(e){try{const s=e.replace(/```json\s*\n?/g,"").replace(/```\s*\n?/g,"").trim().match(/\{[\s\S]*\}/);if(s){const r=JSON.parse(s[0]);if(r.rq||r.theme||r.type)return r}}catch{}return null}function Oe(e){const t={type:"research",theme:"",rq:"",target:"",goal:"",approaches:[]},s=e.match(/リサーチクエスチョン[（(]?RQ[)）]?\s*[:：]\s*(.+?)(?:\n|$)/i)||e.match(/RQ\s*[:：]\s*(.+?)(?:\n|$)/i);s&&(t.rq=s[1].trim());const r=e.match(/研究デザイン\s*[:：]\s*(.+?)(?:\n|$)/);r&&(t.theme=r[1].trim());const i=e.match(/対象\s*[:：]\s*(.+?)(?:\n|$)/);i&&(t.target=i[1].trim());const n=e.match(/最終ゴール\s*[:：]\s*(.+?)(?:\n|$)/);n&&(t.goal=n[1].trim()),!t.theme&&t.rq&&(t.theme=t.rq.replace(/[？?]$/,"").substring(0,60));const o=e.matchAll(/(?:量的|質的|STEP\s*\d+|フェーズ)[^:：]*[:：]\s*([\s\S]*?)(?=(?:量的|質的|STEP\s*\d+|フェーズ|最終ゴール|---|\n\n|$))/gi);for(const l of o){const c=l[0].trim(),d=c.match(/^(.+?)[:：]/);d&&t.approaches.push({name:d[1].trim(),description:c.substring(d[0].length).trim().replace(/\n/g," ").substring(0,200)})}return t.rq?t:e.trim().length>30?(t.rq=e.trim().split(`
`)[0].substring(0,200),t.goal=e.trim(),t):null}function D(e){const t=a.get("seed.rqConfirmed"),s={research:{title:"リサーチクエスチョン",badge:"学術研究"},practice:{title:"実践報告の焦点",badge:"実践報告"},qi:{title:"QIプロジェクト目標",badge:"質改善"}},r=s[e.type]||s.research;return`
  ...
  `}function $(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Ce(){return!!a.get("seed.refinedResult")&&!!a.get("seed.rqConfirmed")}function N(e,t){const s=e.querySelector("#btnConfirmRq"),r=e.querySelector("#refinedRqInput");if(!s||!r)return;const i=()=>{r.style.height="auto",r.style.height=Math.max(80,r.scrollHeight+2)+"px"};requestAnimationFrame(i),setTimeout(i,100),r.addEventListener("input",i),s.addEventListener("click",()=>{r.value.trim()&&(t.rq=r.value.trim(),a.set("seed.refinedResult",t),a.set("seed.rqConfirmed",!0),$("Theme",(t.theme||t.title||t.rq).substring(0,60)),$("RQ",t.rq),e.innerHTML=D(t),N(e,t))})}function ze(e){const t=a.get("rq"),s=a.get("seed.refinedResult");if(!s){e.innerHTML=`
      <div class="fade-in">
  ...
  `;const o=e.querySelector("#btnGenerateDesign");o?o.addEventListener("click",()=>ve(!1)):r&&Q(e)}function ve(e=!1){const t=a.get("seed.refinedResult"),s=a.get("rq.proposalHistory")||[],r=a.get("rq.aiResults");let i=`
...
${i}`;if(M()){const l=JSON.parse(k.designSelection);if(e&&r){const d=[...s,r];a.set("rq.proposalHistory",d)}a.set("rq.aiResults",l),a.set("rq.selectedDesign",null);const c=document.querySelector("#designProposalArea");if(c){const d=a.get("rq.proposalHistory")||[];c.innerHTML=G(l,null,d),Q(c)}return}const o=document.querySelector("#designProposalArea");o&&(o.innerHTML=E({prompt:n,containerId:"geminiDesign",label:"研究デザイン提案",expectJson:!1,placeholder:"Geminiが出力した「📋 研究デザイン提案」をここにコピー＆ペーストしてください..."}),T(o,n,(l,c)=>{const d=c||l||"";let u=null;try{const m=d.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"design"\s*:[\s\S]*\}/);if(m){const g=JSON.parse(m[0]);u=De(g)}}catch{}if(u||(u=Ne(d)),u){if(e&&r){const m=[...s,r];a.set("rq.proposalHistory",m)}a.set("rq.aiResults",u),a.set("rq.selectedDesign",null);const p=a.get("rq.proposalHistory")||[];o.innerHTML=G(u,null,p),Q(o)}else alert("提案内容を判読できませんでした。Geminiが出力した「📋 研究デザイン提案」の部分をそのまま貼り付けてください。")}))}function De(e){return Array.isArray(e)&&(e=e[0]),e.proposals&&(e=e.proposals[0]),{design:e.design||e.title||e.name||"デザイン提案",vision:e.vision||e.description||e.overview||"",finer:e.finer||{},reason:e.reason||e.recommendation||e.rationale||""}}function Ne(e){e=e.replace(/\*\*(.+?)\*\*/g,"$1").replace(/^[-•]\s*/gm,"").replace(/^\d+\.\s*/gm,"");const t={design:"",vision:"",finer:{},reason:""},s=e.match(/推奨デザイン\s*[:：]\s*(.+?)(?:\n|$)/);s&&(t.design=s[1].trim());const r=e.match(/研究のビジョン\s*[:：]\s*([\s\S]*?)(?=(?:FINER|推奨理由|---|$))/);r&&(t.vision=r[1].trim());const i=e.match(/実現可能性[（(]?F[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);i&&(t.finer.f=i[1].trim());const n=e.match(/面白さ[（(]?I[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);n&&(t.finer.i=n[1].trim());const o=e.match(/新規性[（(]?N[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);o&&(t.finer.n=o[1].trim());const l=e.match(/倫理性[（(]?E[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);l&&(t.finer.e=l[1].trim());const c=e.match(/関連性[（(]?R[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);c&&(t.finer.r=c[1].trim());const d=e.match(/推奨理由\s*[:：]\s*([\s\S]*?)(?=(?:---|✅|📌|$))/);return d&&(t.reason=d[1].trim()),!t.design&&e.trim().length>30&&(t.design=e.trim().split(`
`)[0].substring(0,100)),t.design?t:null}function G(e,t,s){const r=t===e.design,i=Pe(e.finer);let n="";return s.length>0&&(n=`
  ...
  `}function Pe(e){if(!e||Object.keys(e).length===0)return"";const s=Object.entries({f:{icon:"✅",label:"実現可能性"},i:{icon:"💡",label:"面白さ"},n:{icon:"🆕",label:"新規性"},e:{icon:"🛡️",label:"倫理性"},r:{icon:"🎯",label:"関連性"}}).map(([r,i])=>{const n=e[r];return!n||n===!0?"":`
    ...
    <div class="fade-in">
      ...
      <div class="card" style="margin-bottom: var(--space-6);">
        ...
        <table class="data-table data-table-selectable" id="designTable">
          ...
          <tbody>
            ${_e.map(l=>{const c=(s==null?void 0:s.name)===l.guideline&&t===l.type,d=r&&l.recommendFor.includes(r);return`
  ...
  `,s&&ce(s.name),e.querySelectorAll("#designTable tbody tr").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.type;l.dataset.guideline,a.set("rq.selectedDesign",c),a.set("guideline.checklist",[]),a.set("guideline.notes",{});const d=O[c]||de(c);d&&a.set("guideline.selected",d.name),e.querySelectorAll("#designTable tbody tr").forEach(p=>{p.classList.remove("selected-row");const m=p.querySelector("td:last-child");m&&(m.innerHTML="")}),l.classList.add("selected-row");const u=l.querySelector("td:last-child");if(u&&(u.innerHTML='<span class="tag tag-primary">✓ 選択中</span>'),d){const p=e.querySelector("#guidelineDetailArea"),m=z[d.name]||[];p.innerHTML=oe(d,m,{}),le(e),ce(d.name)}Je("Design",c)})}),le(e)}function oe(e,t,s){const r=Object.values(s).filter(i=>i&&i.trim()).length;return`
  ...
  `:""}function de(e){if(!e)return null;if(O[e])return O[e];for(const[t,s]of Object.entries(O))if(e.includes(t)||t.includes(e))return s;return O.横断研究}function Je(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Ue(){return!!a.get("guideline.selected")}function Be(e){return z[e]||[]}function Fe(e){const t=a.get("review");e.innerHTML=`
    <div class="fade-in">
  ...
  `;const s=e.querySelector("#reviewKeywords"),r=e.querySelector("#reviewLang"),i=e.querySelector("#reviewContext");s.addEventListener("input",()=>a.set("review.keywords",s.value)),r.addEventListener("change",()=>a.set("review.language",r.value)),i==null||i.addEventListener("change",()=>a.set("review.context",i.value)),e.querySelector("#btnReview").addEventListener("click",We);const n=e.querySelector("#btnSuggestQueries");n&&n.addEventListener("click",Ke),t.suggestedQueries&&J(t.suggestedQueries)}function Ke(){const e=document.querySelector("#suggestedQueriesArea");if(!e)return;const t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",r=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",n=a.get("rq.selectedDesign")||"",o=`
研究テーマ: ${s}
リサーチクエスチョン: ${r}
研究の目的: ${i}
研究デザイン: ${n}
...
${o}`;if(M()){const c=JSON.parse(k.searchQuerySuggestion);a.set("review.suggestedQueries",c),J(c);const d=document.querySelector("#reviewKeywords");if(d&&!d.value.trim()&&c.keywordsJa){const u=c.keywordsJa.join(" ");d.value=u,a.set("review.keywords",u)}return}e.style.display="block",e.innerHTML=E({prompt:l,containerId:"geminiSuggest",label:"検索キーワード・式の提案",expectJson:!1,placeholder:"Geminiが出力した「📋 検索キーワード」をここにコピー＆ペーストしてください..."}),T(e,l,(c,d)=>{const u=d||c||"";let p=null;try{const g=u.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"keywordsJa"[\s\S]*\}/);g&&(p=JSON.parse(g[0]))}catch{}if(p||(p=Ve(u)),p){a.set("review.suggestedQueries",p),J(p);const m=document.querySelector("#reviewKeywords");if(m&&!m.value.trim()&&p.keywordsJa){const f=(Array.isArray(p.keywordsJa)?p.keywordsJa:[p.keywordsJa]).join(" ");m.value=f,a.set("review.keywords",f)}}else e.innerHTML=`
  ...
  `}function We(){const e=a.get("review"),t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",r=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",n=a.get("rq.selectedDesign")||"",o=a.get("guideline.selected")||"",l=a.get("guideline.notes")||{},c=Be(o);let d="";if(c.length>0){const g=[],f=[];c.forEach((S,h)=>{const b=l[h];b&&b.trim()?g.push(`✓ ${S}: ${b.trim()}`):f.push(`□ ${S}`)}),g.length>0&&(d+=`
検討済みの項目:
${g.join(`
`)}`),f.length>0&&(d+=`
未検討の項目（文献レビューで補完が必要）:
...
${u}`;if(M()){const g=JSON.parse(k.literatureReview);a.set("review.aiResult",g),document.querySelector("#step4Results").innerHTML=U(g);const f=document.querySelector("#sumLiterature");f&&(f.textContent="背景構築済み",f.classList.add("active"));return}const m=document.querySelector("#step4Results");m.innerHTML=E({prompt:p,containerId:"geminiReview",label:"背景・意義の論理構成",expectJson:!1,placeholder:"Geminiが出力した「📋 研究背景・意義の論理構成案」をここにコピー＆ペーストしてください..."}),T(m,p,(g,f)=>{const S=f||g||"";let h=null;try{const A=S.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"structure"[\s\S]*\}/);A&&(h=JSON.parse(A[0]))}catch{}h||(h={structure:S}),a.set("review.aiResult",h),m.innerHTML=U(h);const b=document.querySelector("#sumLiterature");b&&(b.textContent="背景構築済み",b.classList.add("active"))})}function U(e){return`
    <div class="ai-response">
  ...
  `,e.querySelectorAll('#dataTypeGroup input[type="checkbox"]').forEach(i=>{i.addEventListener("change",()=>{const n=Array.from(e.querySelectorAll("#dataTypeGroup input:checked")).map(l=>l.value);a.set("data.types",n),e.querySelectorAll("#dataTypeGroup .checkbox-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#typeOtherWrapper");if(o&&(o.style.display=n.includes("other")?"block":"none",!n.includes("other"))){a.set("data.typeOtherText","");const l=e.querySelector("#typeOtherText");l&&(l.value="")}I()})});const s=e.querySelector("#typeOtherText");s&&s.addEventListener("input",i=>{a.set("data.typeOtherText",i.target.value),I()}),e.querySelector("#sampleSize").addEventListener("input",i=>{a.set("data.sampleSize",i.target.value),I()}),e.querySelectorAll('input[name="grouping"]').forEach(i=>{i.addEventListener("change",n=>{a.set("data.grouping",n.target.value),e.querySelectorAll("#groupingGroup .radio-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#groupingOtherWrapper");if(o&&(o.style.display=n.target.value==="other"?"block":"none",n.target.value!=="other")){a.set("data.groupingOtherText","");const l=e.querySelector("#groupingOtherText");l&&(l.value="")}I()})});const r=e.querySelector("#groupingOtherText");r&&r.addEventListener("input",i=>{a.set("data.groupingOtherText",i.target.value),I()})}function I(){const e=a.get("data"),t=document.querySelector("#dataSummaryContent");t&&(t.innerHTML=ye(e));const s=document.querySelector("#sumData");if(s){const r=e.types||[];if(r.length>0){const i=r.map(n=>{var o;return((o=Y.find(l=>l.id===n))==null?void 0:o.label.split("（")[0])||n});s.textContent=i.join("、"),s.classList.add("active")}}}function ye(e){var r;const t=(e.types||[]).map(i=>Y.find(n=>n.id===i));let s=((r=fe.find(i=>i.value===e.grouping))==null?void 0:r.label)||"未選択";return e.grouping==="other"&&e.groupingOtherText&&(s+=`（${pe(e.groupingOtherText)}）`),t.length===0&&!e.sampleSize&&!e.grouping?'<p style="color: var(--color-text-muted);">データを選択すると、ここに概要が表示されます。</p>':`
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-4);">
      <div>
        <strong>データタイプ（${t.length}種類）</strong>
        <ul style="margin-top: var(--space-2); padding-left: var(--space-5);">
          ${t.map(i=>{if(!i)return"";let n=i.label;return i.id==="other"&&e.typeOtherText&&(n+=`（${pe(e.typeOtherText)}）`),`<li>${i.icon} ${n}</li>`}).join("")||'<li style="color: var(--color-text-muted);">未選択</li>'}
        </ul>
      </div>
      <div>
  ...
  `}function Ze(){const e=a.get("data");return(e.types||[]).length>0&&e.grouping}function pe(e){return e?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}const ue={"2groups":{continuous:{normal:"t検定（独立2群）",nonNormal:"Mann-Whitney U検定"},categorical:"χ²検定 / Fisher正確確率検定"},"3groups":{continuous:{normal:"一元配置分散分析（ANOVA）",nonNormal:"Kruskal-Wallis検定"},categorical:"χ²検定"},prepost:{continuous:{normal:"対応のあるt検定",nonNormal:"Wilcoxon符号付順位和検定"},categorical:"McNemar検定"},none:{continuous:{normal:"記述統計、相関分析",nonNormal:"Spearman順位相関"},categorical:"度数分布、記述統計"}};function et(e){const t=a.get("analysis"),s=a.get("data");e.innerHTML=`
    <div class="fade-in">
  ...
  `,e.querySelector("#btnAnalysis").addEventListener("click",st)}function tt(e){var d,u;const t=e.grouping||"none",s=e.types||[],r=ue[t]||ue.none,i=s.some(p=>["vitals","labs","scales"].includes(p)),n=s.some(p=>["attributes","intervention"].includes(p)),o=s.includes("timeseries"),l=s.some(p=>["interview","observation"].includes(p)),c=[];return i&&c.push(`<li><strong>連続変数の群比較:</strong> ${((d=r.continuous)==null?void 0:d.normal)||r.continuous||"記述統計"}（正規分布を仮定）/ ${((u=r.continuous)==null?void 0:u.nonNormal)||"非パラメトリック検定"}（正規分布でない場合）</li>`),n&&c.push(`<li><strong>カテゴリ変数:</strong> ${r.categorical}</li>`),o&&c.push("<li><strong>時系列分析:</strong> 線形混合モデル（Linear Mixed Model）/ 反復測定分散分析</li>"),l&&c.push("<li><strong>質的データ:</strong> 質的内容分析 / テーマ分析 / グラウンデッドセオリー</li>"),e.sampleSize&&parseInt(e.sampleSize)<30&&c.push('<li style="color: var(--color-warning);"><strong>⚠️ 注意:</strong> サンプルサイズが30未満のため、ノンパラメトリック検定の使用を推奨します</li>'),c.length===0?'<p style="color: var(--color-text-muted);">Step 5でデータを選択すると、自動提案が表示されます。</p>':`<ul style="padding-left: var(--space-5);">${c.join("")}</ul>`}function st(){var n;const e=a.get("data"),s=`
...
`)[0].substring(0,100),t.primaryAnalysis.reason=e.trim(),t):null}function B(e){var t;return`
  ...
  `}function nt(){return!!a.get("analysis.aiResult")}function rt(e){const t=a.get("proposal");e.innerHTML=`
    <div class="fade-in">
  ...
  `,e.querySelector("#btnGenerate").addEventListener("click",ot),t.draft&&K(t.draft)}function at(){var o,l;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review");a.get("data");const i=a.get("analysis"),n=e.refinedResult;return`
    <div>
    ...
    `}function ot(){var g,f,S,h,b,C,A,X,Z,ee,te,se,ie,ne,re,ae;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review"),i=a.get("data"),n=a.get("analysis"),o=s.selected||"",l=s.notes||{},c=z[o]||[];let d="";if(c.length>0){const v=[];c.forEach(($e,xe)=>{const _=l[xe];_&&_.trim()&&v.push(`  ✓ ${$e}: ${_.trim()}`)}),v.length>0&&(d=`
...
【研究テーマ】
${((g=e.refinedResult)==null?void 0:g.theme)||((f=e.refinedResult)==null?void 0:f.title)||""}

【リサーチクエスチョン】
${((S=e.refinedResult)==null?void 0:S.rq)||e.question||""}

【研究デザイン】
${t.selectedDesign||""}

【研究の骨子】
対象: ${((h=e.refinedResult)==null?void 0:h.target)||"未整理"}
ゴール: ${((b=e.refinedResult)==null?void 0:b.goal)||"未整理"}
アプローチ: ${(((C=e.refinedResult)==null?void 0:C.approaches)||[]).map(v=>`${v.name}: ${v.description}`).join(`
`)}
...
【文献レビュー概要（論理構成案）】
${((A=r.aiResult)==null?void 0:A.structure)||"未実施"}
...
${u}`;if(M()){const v=k.proposalDraft;a.set("proposal.draft",v),document.querySelector("#step7Results").innerHTML=F(v),K(v);return}const m=document.querySelector("#step7Results");m.innerHTML=E({prompt:p,containerId:"geminiProposal",label:"研究計画書草案の生成",expectJson:!1,placeholder:"Geminiからの研究計画書草案をここに貼り付けてください..."}),T(m,p,v=>{v&&(a.set("proposal.draft",v),m.innerHTML=F(v),K(v))})}function lt(e){const t="display:inline-block;background:#fff3cd;color:#856404;font-size:0.7rem;padding:1px 6px;border-radius:3px;margin-left:4px;font-weight:bold;vertical-align:middle;border:1px solid #f0c36d;",s={lit:`<span style="${t}" title="文献を自身で検索し、実在を確認してください">⚠️文献要確認</span>`,stat:`<span style="${t}" title="統計の専門家に妥当性を確認してください">⚠️統計要確認</span>`,sample:`<span style="${t}" title="サンプルサイズの計算根拠を自身で検証してください">⚠️要検証</span>`,ethics:`<span style="${t}" title="施設の倫理審査要件に合わせて修正してください">⚠️施設に合わせて修正</span>`,citation:`<span style="${t}background:#f8d7da;color:#721c24;border-color:#f5c6cb;" title="実在する文献に差し替えてください">🔴出典未確認</span>`};let r=0;const i=n=>(r++,n);return e=e.replace(/出典確認中/g,()=>i(`出典確認中 ${s.citation}`)),e=e.replace(/(先行研究によ(?:れば|ると))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/(既存の(?:エビデンス|研究|知見)(?:では|によ(?:れば|ると)))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/((?:国内外の|複数の|多くの|近年の)(?:研究|報告|調査)(?:では|で|が|において))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/((?:メタアナリシス|システマティックレビュー)(?:では|によ(?:れば|ると)))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/(t検定|χ²検定|カイ二乗検定|Mann-Whitney|Wilcoxon|ANOVA|分散分析|ロジスティック回帰|Cox比例ハザード|Kaplan-Meier|ログランク検定|線形混合モデル|共分散分析|因子分析|主成分分析|構造方程式)/g,n=>i(`${n} ${s.stat}`)),e=e.replace(/((?:サンプルサイズ|標本サイズ|症例数)(?:は|を|の)[^<]{5,60}?(?:名|例|人|とする|と設定|を目標))/g,n=>i(`${n} ${s.sample}`)),e=e.replace(/(インフォームド・コンセント)/g,n=>i(`${n} ${s.ethics}`)),e=e.replace(/(倫理審査委員会(?:の承認|に申請|の審査))/g,n=>i(`${n} ${s.ethics}`)),{html:e,count:r,tags:s}}function F(e){let t=e.replace(/^# (.+)$/gm,'<h2 style="margin-top: var(--space-6); color: var(--color-primary-dark); border-bottom: 2px solid var(--color-primary-border); padding-bottom: var(--space-2);">$1</h2>').replace(/^## (.+)$/gm,'<h3 style="margin-top: var(--space-5); color: var(--color-text);">$1</h3>').replace(/^### (.+)$/gm,'<h4 style="margin-top: var(--space-4); color: var(--color-text-secondary);">$1</h4>').replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/^- (.+)$/gm,"<li>$1</li>").replace(/\n\n/g,"</p><p>").replace(/\n/g,"<br>");const{html:s,count:r,tags:i}=lt(t);return t=s,`
  ...
  `}function K(e){const t=document.querySelector("#btnCopyProposal");t&&t.addEventListener("click",()=>{navigator.clipboard.writeText(e).then(()=>{t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)}).catch(()=>{const i=document.createElement("textarea");i.value=e,document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)})});const s=document.querySelector("#btnDownloadWord");s&&s.addEventListener("click",()=>{ct(e)});const r=document.querySelector("#btnDownloadPDF");r&&r.addEventListener("click",()=>{dt(e)})}function ct(e){var l,c,d,u;const s=`
<!DOCTYPE html>
...
<body>
  ${t}
...
</html>`),s.document.close(),setTimeout(()=>{s.print()},500)}function pt(){return!!a.get("proposal.draft")}const ut=[{id:1,render:Te,validate:Ce},{id:2,render:ze,validate:He},{id:3,render:je,validate:Ue},{id:4,render:Fe,validate:Ye},{id:5,render:Xe,validate:Ze},{id:6,render:et,validate:nt},{id:7,render:rt,validate:pt}],mt=document.getElementById("stepContent"),gt=document.getElementById("progressFill"),he=document.querySelectorAll(".step-tab"),be=document.getElementById("btnPrev"),R=document.getElementById("btnNext"),vt=document.getElementById("stepIndicator"),q=document.getElementById("settingsModal");let y=a.get("currentStep")||1,me=!1;function Se(){me||(me=!0,a.hasSavedData()&&$t(),P(),H(),St(),ht(),bt(),xt(),V())}function P(){const e=ut.find(t=>t.id===y);e&&e.render(mt)}const ft={1:{label:"種と整理",affects:[2,4,6,7],dataKeys:["seed.refinedResult"]},2:{label:"デザイン案",affects:[3,4,6,7],dataKeys:["rq.selectedDesign","rq.aiResults"]},3:{label:"ガイドライン",affects:[4,7],dataKeys:["guideline.selected"]},4:{label:"文献レビュー",affects:[7],dataKeys:["review.aiResult"]},5:{label:"データ収集",affects:[6,7],dataKeys:["data.types","data.sampleSize"]},6:{label:"分析方法",affects:[7],dataKeys:["analysis.aiResult"]}},ge={1:"種と整理",2:"デザイン案",3:"ガイドライン",4:"文献レビュー",5:"データ収集",6:"分析方法",7:"計画書草案"};function W(e){if(!(e<1||e>7)){if(e<y){const t=ft[e];if(t){const s=t.affects.filter(r=>r===2?!!a.get("rq.aiResults"):r===3?!!a.get("guideline.selected"):r===4?!!a.get("review.aiResult"):r===6?!!a.get("analysis.aiResult"):r===7?!!a.get("proposal.draft"):!1);s.length>0&&yt(e,s)}}y=e,a.set("currentStep",y),P(),H(),window.scrollTo({top:0,behavior:"smooth"})}}function yt(e,t){const s=t.map(n=>`Step ${n}（${ge[n]}）`).join("、"),r=document.getElementById("staleDataWarning");r&&r.remove();const i=document.createElement("div");i.id="staleDataWarning",i.style.cssText="position:fixed;top:0;left:0;right:0;z-index:9999;background:linear-gradient(135deg,#fff3cd,#ffeeba);border-bottom:2px solid #f0c36d;padding:12px 20px;display:flex;align-items:center;gap:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1);",i.innerHTML=`
      <span style="font-size:1.3rem;">🔄</span>
      <div style="flex:1;color:#856404;font-size:0.9rem;">
        <strong>Step ${e}（${ge[e]}）を修正すると、${s} の内容が古くなる可能性があります。</strong><br>
    ...
    `,document.body.prepend(i),setTimeout(()=>{i.parentElement&&i.remove()},1e4)}function H(){const e=y/7*100;gt.style.width=`${e}%`,he.forEach(t=>{const s=parseInt(t.dataset.step);t.classList.toggle("active",s===y),t.classList.toggle("completed",a.get("completedSteps").has(s))}),be.disabled=y===1,y===7?(R.innerHTML="✅ 完了",R.classList.remove("btn-primary"),R.classList.add("btn-success")):(R.innerHTML=`
      確認して次へ
    ...
    `,document.body.appendChild(e),document.getElementById("btnResume").addEventListener("click",()=>{a.loadFullState(),y=a.get("currentStep")||1,P(),H(),V(),e.remove()}),document.getElementById("btnNewProject").addEventListener("click",()=>{a.reset()})}function xt(){const e=document.getElementById("btnExport"),t=document.getElementById("btnImport"),s=document.getElementById("fileImport");e&&e.addEventListener("click",()=>{a.exportToJSON();const r=e.innerHTML;e.innerHTML="✅ 保存しました",setTimeout(()=>{e.innerHTML=r},2e3)}),t&&s&&(t.addEventListener("click",()=>{s.click()}),s.addEventListener("change",async r=>{const i=r.target.files[0];if(i){try{await a.importFromJSON(i),y=a.get("currentStep")||1,P(),H(),V();const n=t.innerHTML;t.innerHTML="✅ 読み込み完了",setTimeout(()=>{t.innerHTML=n},2e3)}catch(n){alert("ファイルの読み込みに失敗しました: "+n.message)}s.value=""}}))}document.addEventListener("DOMContentLoaded",Se);document.readyState!=="loading"&&Se();
