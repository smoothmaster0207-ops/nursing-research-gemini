(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();const ye={demoMode:!1,currentStep:1,completedSteps:new Set,seed:{question:"",target:"",direction:"",chatHistory:[],refinedResult:null},rq:{aiResults:null,proposalHistory:[],selectedDesign:null},guideline:{selected:null,checklist:[],notes:{}},review:{keywords:"",years:"5",language:"ja+en",database:"PubMed",suggestedQueries:null,aiResult:null},data:{types:[],typeOtherText:"",sampleSize:"",grouping:"",groupingOtherText:""},analysis:{aiResult:null},proposal:{draft:""}};class he{constructor(){this._state=JSON.parse(JSON.stringify(ye,(t,s)=>s instanceof Set?[...s]:s)),this._state.completedSteps=new Set,this._listeners=[],this._load()}get(t){return t.split(".").reduce((s,n)=>s==null?void 0:s[n],this._state)}set(t,s){const n=t.split("."),i=n.pop(),r=n.reduce((o,l)=>o[l],this._state);r[i]=s,this._notify(t),this._save()}update(t,s){const n=this.get(t);this.set(t,s(n))}subscribe(t){return this._listeners.push(t),()=>{this._listeners=this._listeners.filter(s=>s!==t)}}_notify(t){this._listeners.forEach(s=>s(t,this._state))}_save(){try{const t={...this._state};t.completedSteps=[...this._state.completedSteps],localStorage.setItem("research-app-gemini-state",JSON.stringify(t))}catch{}}_load(){try{const t=localStorage.getItem("research-app-gemini-demo-mode");t!==null&&(this._state.demoMode=t==="true")}catch(t){console.warn("Failed to load state, using defaults",t)}}hasSavedData(){var t,s,n;try{const i=localStorage.getItem("research-app-gemini-state");if(!i)return!1;const r=JSON.parse(i);return!!((t=r.seed)!=null&&t.question||(s=r.seed)!=null&&s.refinedResult||(n=r.rq)!=null&&n.selectedDesign)}catch{return!1}}loadFullState(){try{const t=localStorage.getItem("research-app-gemini-state");if(!t)return!1;const s=JSON.parse(t);return["seed","rq","guideline","review","data","analysis","proposal","currentStep"].forEach(i=>{s[i]!==void 0&&(this._state[i]=s[i])}),s.completedSteps&&(this._state.completedSteps=new Set(s.completedSteps)),this._notify("*"),!0}catch(t){return console.warn("Failed to load full state:",t),!1}}exportToJSON(){var l,c,d,p;const t={_exportedAt:new Date().toISOString(),_version:"1.0-gemini",seed:this._state.seed,rq:this._state.rq,guideline:this._state.guideline,review:this._state.review,data:this._state.data,analysis:this._state.analysis,proposal:this._state.proposal,currentStep:this._state.currentStep,completedSteps:[...this._state.completedSteps]},s=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(s),i=document.createElement("a"),r=new Date().toISOString().slice(0,10),o=(((c=(l=this._state.seed)==null?void 0:l.refinedResult)==null?void 0:c.rq)||((p=(d=this._state.seed)==null?void 0:d.refinedResult)==null?void 0:p.title)||"研究計画").substring(0,20);i.href=n,i.download=`研究計画_${o}_${r}.json`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(n)}importFromJSON(t){return new Promise((s,n)=>{const i=new FileReader;i.onload=r=>{try{const o=JSON.parse(r.target.result);["seed","rq","guideline","review","data","analysis","proposal","currentStep"].forEach(c=>{o[c]!==void 0&&(this._state[c]=o[c])}),o.completedSteps&&(this._state.completedSteps=new Set(o.completedSteps)),this._save(),this._notify("*"),s(!0)}catch(o){n(o)}},i.onerror=()=>n(new Error("ファイルの読み込みに失敗しました")),i.readAsText(t)})}saveDemoMode(t){this._state.demoMode=t,localStorage.setItem("research-app-gemini-demo-mode",String(t))}reset(){localStorage.removeItem("research-app-gemini-state"),location.reload()}}const a=new he,L={designSelection:`あなたは熟練した看護系研究者・教育者としての専門アドバイザーです。
...
Ⅴ. 期待される成果
看護師の業務負担を最適化しつつ、患者の安全な在宅移行を実現するためのエビデンスを提示する。`},fe="https://gemini.google.com/app";async function be(e){try{return await navigator.clipboard.writeText(e),!0}catch{const s=document.createElement("textarea");s.value=e,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select();try{return document.execCommand("copy"),document.body.removeChild(s),!0}catch{return document.body.removeChild(s),!1}}}function Se(){window.open(fe,"_blank","noopener,noreferrer")}function T(e){const{prompt:t,containerId:s,label:n="AI回答",expectJson:i=!1,placeholder:r="Geminiからの回答をここに貼り付けてください..."}=e;return`
...
...(続き)`:""}</div>
        ...
        <div class="gemini-step" style="display: flex; gap: var(--space-3); align-items: flex-start; padding: var(--space-4); background: var(--color-bg-secondary, #f8f9fa); border-radius: var(--radius-md);">
          ...
          <div style="flex: 1;">
            ...
            <textarea class="textarea gemini-response-input" id="${s}-response" placeholder="${r}" rows="6" style="width: 100%; box-sizing: border-box;"></textarea>
    ...
    `}function k(e,t,s,n=!1){const i=e.querySelector(".gemini-copy-btn"),r=e.querySelector(".gemini-open-btn"),o=e.querySelector(".gemini-response-input"),l=e.querySelector(".gemini-submit-btn"),c=e.querySelector(".gemini-copy-feedback");i&&i.addEventListener("click",async()=>{const d=await be(t);c&&(c.textContent=d?"✅ コピーしました！":"❌ コピーに失敗しました",c.style.opacity="1",setTimeout(()=>{c.style.opacity="0"},2500))}),r&&r.addEventListener("click",()=>{Se()}),o&&l&&(o.addEventListener("input",()=>{l.disabled=!o.value.trim()}),l.addEventListener("click",()=>{const d=o.value.trim();if(d)if(n)try{const p=d.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim(),u=JSON.parse(p);s(u,d)}catch{s(null,d)}else s(d,d)}))}function O(){return a.get("demoMode")}function $e(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function we(e){const t=a.get("seed"),s=t.refinedResult||null;e.innerHTML=`
    <div class="fade-in">
  ...
  `;const n=e.querySelector("#seedQuestion"),i=e.querySelector("#btnStartChat"),r=e.querySelector("#geminiArea"),o=e.querySelector("#privacyModal"),l=e.querySelector("#btnOpenPrivacyModal"),c=e.querySelector("#btnClosePrivacyModal");if(l&&l.addEventListener("click",()=>{o.classList.add("visible")}),c&&c.addEventListener("click",()=>{o.classList.remove("visible")}),o&&o.addEventListener("click",d=>{d.target===o&&o.classList.remove("visible")}),n.addEventListener("input",()=>{a.set("seed.question",n.value),i.disabled=!n.value.trim()}),i.addEventListener("click",()=>{r.classList.remove("hidden"),xe(n.value),r.scrollIntoView({behavior:"smooth"})}),s){const d=e.querySelector("#refinedResultArea");D(d,s),S("Theme",(s.theme||s.rq||"").substring(0,60)),S("RQ",s.rq||"")}}function xe(e){const t=`${L.rqAssistant}

---

【ユーザーからの研究の種】
${e}`,s=document.querySelector("#geminiChatUI");if(s){if(O()){Re();return}s.innerHTML=T({prompt:t,containerId:"geminiChat",label:"ブレインストーミング（研究の種の整理）",expectJson:!1,placeholder:"Geminiが出力した「📋 研究の骨子」をここにコピー＆ペーストしてください..."}),k(s,t,n=>{if(n){const i=n||"";let r=qe(i);if(r||(r=Le(i)),r){a.set("seed.refinedResult",r);const o=document.querySelector("#refinedResultArea");o&&(o.classList.remove("hidden"),o.innerHTML=N(r),D(o,r),o.scrollIntoView({behavior:"smooth"})),S("Theme",(r.theme||r.rq||"").substring(0,60)),S("RQ",r.rq||""),s.innerHTML=`
        ...
        `}else alert("骨子の内容を判読できませんでした。Geminiが出力した「📋 研究の骨子」の部分をそのまま貼り付けてください。")}})}}function Re(e){const t=JSON.parse(E.rqOverview);a.set("seed.refinedResult",t);const s=document.querySelector("#geminiChatUI");s&&(s.innerHTML=`
      <div class="card" style="background: #f0fdf4; border: 1px solid #86efac; text-align: center; padding: var(--space-4);">
        <p style="color: #166534; font-weight: 600; margin: 0;">✅ デモモード：研究の骨子を自動生成しました。下の内容を確認してください。</p>
      </div>
    `);const n=document.querySelector("#refinedResultArea");n&&(n.classList.remove("hidden"),n.innerHTML=N(t),D(n,t)),S("Theme",(t.theme||t.rq||"").substring(0,60)),S("RQ",t.rq||"")}function qe(e){try{const s=e.replace(/```json\s*\n?/g,"").replace(/```\s*\n?/g,"").trim().match(/\{[\s\S]*\}/);if(s){const n=JSON.parse(s[0]);if(n.rq||n.theme||n.type)return n}}catch{}return null}function Le(e){const t={type:"research",theme:"",rq:"",target:"",goal:"",approaches:[]},s=e.match(/リサーチクエスチョン[（(]?RQ[)）]?\s*[:：]\s*(.+?)(?:\n|$)/i)||e.match(/RQ\s*[:：]\s*(.+?)(?:\n|$)/i);s&&(t.rq=s[1].trim());const n=e.match(/研究デザイン\s*[:：]\s*(.+?)(?:\n|$)/);n&&(t.theme=n[1].trim());const i=e.match(/対象\s*[:：]\s*(.+?)(?:\n|$)/);i&&(t.target=i[1].trim());const r=e.match(/最終ゴール\s*[:：]\s*(.+?)(?:\n|$)/);r&&(t.goal=r[1].trim()),!t.theme&&t.rq&&(t.theme=t.rq.replace(/[？?]$/,"").substring(0,60));const o=e.matchAll(/(?:量的|質的|STEP\s*\d+|フェーズ)[^:：]*[:：]\s*([\s\S]*?)(?=(?:量的|質的|STEP\s*\d+|フェーズ|最終ゴール|---|\n\n|$))/gi);for(const l of o){const c=l[0].trim(),d=c.match(/^(.+?)[:：]/);d&&t.approaches.push({name:d[1].trim(),description:c.substring(d[0].length).trim().replace(/\n/g," ").substring(0,200)})}return t.rq?t:e.trim().length>30?(t.rq=e.trim().split(`
`)[0].substring(0,200),t.goal=e.trim(),t):null}function N(e){const t=a.get("seed.rqConfirmed"),s={research:{title:"リサーチクエスチョン",badge:"学術研究"},practice:{title:"実践報告の焦点",badge:"実践報告"},qi:{title:"QIプロジェクト目標",badge:"質改善"}},n=s[e.type]||s.research;return`
  ...
  `}function S(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Ee(){return!!a.get("seed.refinedResult")&&!!a.get("seed.rqConfirmed")}function D(e,t){const s=e.querySelector("#btnConfirmRq"),n=e.querySelector("#refinedRqInput");if(!s||!n)return;const i=()=>{n.style.height="auto",n.style.height=Math.max(80,n.scrollHeight+2)+"px"};requestAnimationFrame(i),setTimeout(i,100),n.addEventListener("input",i),s.addEventListener("click",()=>{n.value.trim()&&(t.rq=n.value.trim(),a.set("seed.refinedResult",t),a.set("seed.rqConfirmed",!0),S("Theme",(t.theme||t.title||t.rq).substring(0,60)),S("RQ",t.rq),e.innerHTML=N(t),D(e,t))})}function Te(e){const t=a.get("rq"),s=a.get("seed.refinedResult");if(!s){e.innerHTML=`
      <div class="fade-in">
    ...
    `;return}const n=t.aiResults,i=t.proposalHistory||[],r=t.selectedDesign;e.innerHTML=`
    <div class="fade-in">
  ...
  `;const o=e.querySelector("#btnGenerateDesign");o?o.addEventListener("click",()=>ce(!1)):n&&C(e)}function ce(e=!1){const t=a.get("seed.refinedResult"),s=a.get("rq.proposalHistory")||[],n=a.get("rq.aiResults");let i=`
整理されたリサーチクエスチョン: ${t.rq||t.title||"未設定"}
対象: ${t.target||"未設定"}
ゴール: ${t.goal||"未設定"}
アプローチ例: ${(t.approaches||[]).map(l=>l.name).join(", ")}
  `.trim();if(e&&(n||s.length>0)){const l=[];s.forEach(c=>l.push(c.design)),n&&l.push(n.design),i+=`

【重要】以下の研究デザインはすでに提案済みです。これらとは異なる視点・方法論の研究デザインを提案してください：
${l.map((c,d)=>`${d+1}. ${c}`).join(`
`)}`}const r=`${L.designSelection}

---

${i}`;if(O()){const l=JSON.parse(E.designSelection);if(e&&n){const d=[...s,n];a.set("rq.proposalHistory",d)}a.set("rq.aiResults",l),a.set("rq.selectedDesign",null);const c=document.querySelector("#designProposalArea");if(c){const d=a.get("rq.proposalHistory")||[];c.innerHTML=I(l,null,d),C(c)}return}const o=document.querySelector("#designProposalArea");o&&(o.innerHTML=T({prompt:r,containerId:"geminiDesign",label:"研究デザイン提案",expectJson:!0,placeholder:"GeminiからのJSON回答をここに貼り付けてください..."}),k(o,r,(l,c)=>{if(l){const d=de(l);if(e&&n){const u=[...s,n];a.set("rq.proposalHistory",u)}a.set("rq.aiResults",d),a.set("rq.selectedDesign",null);const p=a.get("rq.proposalHistory")||[];o.innerHTML=I(d,null,p),C(o)}else{const d=ke(c);if(d){if(e&&n){const u=[...s,n];a.set("rq.proposalHistory",u)}a.set("rq.aiResults",d),a.set("rq.selectedDesign",null);const p=a.get("rq.proposalHistory")||[];o.innerHTML=I(d,null,p),C(o)}else alert("JSON形式の回答を貼り付けてください。Geminiの回答から { から始まる部分をコピーしてください。")}},!0))}function de(e){return Array.isArray(e)&&(e=e[0]),e.proposals&&(e=e.proposals[0]),{design:e.design||e.title||e.name||"デザイン提案",vision:e.vision||e.description||e.overview||"",finer:e.finer||{},reason:e.reason||e.recommendation||e.rationale||""}}function ke(e){try{const s=e.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"design"\s*:[\s\S]*\}/);if(s){const n=JSON.parse(s[0]);return de(n)}}catch{}return{design:"AIからの提案",vision:e.substring(0,800),finer:{},reason:"（JSONの解析に失敗したため、テキストとして表示しています。）"}}function I(e,t,s){const n=t===e.design,i=Oe(e.finer);let r="";return s.length>0&&(r=`
    ...
    <div class="ai-response">
      ...
      <div class="ai-response-body">
        ...
        <div class="proposal-card main-proposal ${n?"selected":""}" data-design="${w(e.design)}" data-is-current="true">
  ...
  `}function Oe(e){if(!e||Object.keys(e).length===0)return"";const s=Object.entries({f:{icon:"✅",label:"実現可能性"},i:{icon:"💡",label:"面白さ"},n:{icon:"🆕",label:"新規性"},e:{icon:"🛡️",label:"倫理性"},r:{icon:"🎯",label:"関連性"}}).map(([n,i])=>{const r=e[n];return!r||r===!0?"":`
      <div class="finer-detail-row">
        <span class="finer-label">${i.icon} ${i.label}</span>
        <span class="finer-value">${w(String(r))}</span>
      </div>
    ...
    <div class="fade-in">
      ...
      <div class="card" style="margin-bottom: var(--space-6);">
        ...
        <table class="data-table data-table-selectable" id="designTable">
          ...
          <tbody>
            ${Me.map(l=>{const c=(s==null?void 0:s.name)===l.guideline&&t===l.type,d=n&&l.recommendFor.includes(n);return`
  ...
  `,s&&ne(s.name),e.querySelectorAll("#designTable tbody tr").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.type;l.dataset.guideline,a.set("rq.selectedDesign",c),a.set("guideline.checklist",[]),a.set("guideline.notes",{});const d=M[c]||re(c);d&&a.set("guideline.selected",d.name),e.querySelectorAll("#designTable tbody tr").forEach(u=>{u.classList.remove("selected-row");const h=u.querySelector("td:last-child");h&&(h.innerHTML="")}),l.classList.add("selected-row");const p=l.querySelector("td:last-child");if(p&&(p.innerHTML='<span class="tag tag-primary">✓ 選択中</span>'),d){const u=e.querySelector("#guidelineDetailArea"),h=Q[d.name]||[];u.innerHTML=se(d,h,{}),ie(e),ne(d.name)}De("Design",c)})}),ie(e)}function se(e,t,s){const n=Object.values(s).filter(i=>i&&i.trim()).length;return`
    <div class="guideline-card">
      ...
      <div class="checklist" id="guidelineChecklist">
        ...
        ${t.map((i,r)=>{const o=s[r]||"",l=o.trim().length>0;return`
          <div class="checklist-item-note ${l?"has-note":""}">
            <div class="checklist-item-header">
              <div class="checklist-check ${l?"checked":""}" data-index="${r}">
                ${l?"✓":""}
              </div>
              <span class="checklist-label">${i}</span>
            </div>
            <textarea class="checklist-note-input" data-index="${r}" 
  ...
  `}function ie(e){e.querySelectorAll(".checklist-note-input").forEach(t=>{t.value&&(t.style.height="auto",t.style.height=Math.min(t.scrollHeight,120)+"px"),t.addEventListener("input",()=>{const s=t.dataset.index,n=t.value,i=a.get("guideline.notes")||{};i[s]=n,a.set("guideline.notes",i);const r=t.closest(".checklist-item-note"),o=r.querySelector(".checklist-check");n.trim()?(r.classList.add("has-note"),o.classList.add("checked"),o.textContent="✓"):(r.classList.remove("has-note"),o.classList.remove("checked"),o.textContent=""),t.style.height="auto",t.style.height=Math.min(t.scrollHeight,120)+"px",Ce(e);const l=Object.entries(i).filter(([,c])=>c&&c.trim()).map(([c])=>parseInt(c));a.set("guideline.checklist",l)})})}function Ce(e){const t=a.get("guideline.notes")||{},s=Object.values(t).filter(r=>r&&r.trim()).length,n=e.querySelectorAll(".checklist-note-input").length,i=e.querySelector(".checklist-progress");i&&(i.textContent=`${s} / ${n} 項目入力済み`)}function ne(e){const t=document.querySelector("#sumGuideline");t&&(t.textContent=e,t.classList.add("active"))}function Ne(e){const s={research:{icon:"🔬",title:"学術研究として整理されました",designs:"介入研究・観察研究・質的研究",reason:"Step 1 の対話から、仮説の検証や新たな知見の発見を目的とした学術研究と判断しました。研究の目的や方法に応じて、介入研究（RCT等）、観察研究（横断・コホート等）、質的研究（インタビュー・参与観察等）のいずれかを選択してください。"},qi:{icon:"📈",title:"質改善（QI）プロジェクトとして整理されました",designs:"QI（質改善）",reason:"Step 1 の対話から、現場の業務プロセスやケアの質を改善することが主目的と判断しました。QIプロジェクトでは SQUIRE 2.0 ガイドラインに沿って報告することが推奨されています。"},practice:{icon:"📝",title:"実践報告として整理されました",designs:"事例／実践報告",reason:"Step 1 の対話から、臨床での実践経験や症例を共有・報告することが主目的と判断しました。事例報告では CARE ガイドラインに沿って構造化することで、読者にとって再現可能で学びの多い報告になります。"}}[e];return s?`
  ...
  `:""}function re(e){if(!e)return null;if(M[e])return M[e];for(const[t,s]of Object.entries(M))if(e.includes(t)||t.includes(e))return s;return M.横断研究}function De(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Pe(){return!!a.get("guideline.selected")}function ze(e){return Q[e]||[]}function He(e){const t=a.get("review");e.innerHTML=`
    <div class="fade-in">
  ...
  `;const s=e.querySelector("#reviewKeywords"),n=e.querySelector("#reviewLang"),i=e.querySelector("#reviewContext");s.addEventListener("input",()=>a.set("review.keywords",s.value)),n.addEventListener("change",()=>a.set("review.language",n.value)),i==null||i.addEventListener("change",()=>a.set("review.context",i.value)),e.querySelector("#btnReview").addEventListener("click",_e);const r=e.querySelector("#btnSuggestQueries");r&&r.addEventListener("click",Qe),t.suggestedQueries&&_(t.suggestedQueries)}function Qe(){const e=document.querySelector("#suggestedQueriesArea");if(!e)return;const t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",n=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",r=a.get("rq.selectedDesign")||"",o=`
研究テーマ: ${s}
リサーチクエスチョン: ${n}
研究の目的: ${i}
研究デザイン: ${r}
...
${o}`;if(O()){const c=JSON.parse(E.searchQuerySuggestion);a.set("review.suggestedQueries",c),_(c);const d=document.querySelector("#reviewKeywords");if(d&&!d.value.trim()&&c.keywordsJa){const p=c.keywordsJa.join(" ");d.value=p,a.set("review.keywords",p)}return}e.style.display="block",e.innerHTML=T({prompt:l,containerId:"geminiSuggest",label:"検索キーワード・式の提案",expectJson:!0,placeholder:"GeminiからのJSON回答をここに貼り付けてください..."}),k(e,l,(c,d)=>{if(c){a.set("review.suggestedQueries",c),_(c);const p=document.querySelector("#reviewKeywords");if(p&&!p.value.trim()&&c.keywordsJa){const u=c.keywordsJa.join(" ");p.value=u,a.set("review.keywords",u)}}else e.innerHTML=`
  ...
  `)}function _e(){const e=a.get("review"),t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",n=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",r=a.get("rq.selectedDesign")||"",o=a.get("guideline.selected")||"",l=a.get("guideline.notes")||{},c=ze(o);let d="";if(c.length>0){const v=[],y=[];c.forEach((f,b)=>{const R=l[b];R&&R.trim()?v.push(`✓ ${f}: ${R.trim()}`):y.push(`□ ${f}`)}),v.length>0&&(d+=`
検討済みの項目:
${v.join(`
`)}`),y.length>0&&(d+=`
未検討の項目（文献レビューで補完が必要）:
...
${d}
  `.trim(),u=`${L.literatureReview}

---

${p}`;if(O()){const v=JSON.parse(E.literatureReview);a.set("review.aiResult",v),document.querySelector("#step4Results").innerHTML=J(v);const y=document.querySelector("#sumLiterature");y&&(y.textContent="背景構築済み",y.classList.add("active"));return}const h=document.querySelector("#step4Results");h.innerHTML=T({prompt:u,containerId:"geminiReview",label:"背景・意義の論理構成",expectJson:!0,placeholder:"Geminiからの回答をここに貼り付けてください（JSON形式またはテキスト）..."}),k(h,u,(v,y)=>{let f;v?f=v:f={structure:y},a.set("review.aiResult",f),h.innerHTML=J(f);const b=document.querySelector("#sumLiterature");b&&(b.textContent="背景構築済み",b.classList.add("active"))},!0)}function J(e){return`
    <div class="ai-response">
  ...
  `}function Je(){return!!a.get("review.aiResult")}const U=[{id:"attributes",label:"基本属性（年齢・性別など）",icon:"👤"},{id:"vitals",label:"バイタルサイン",icon:"💓"},{id:"labs",label:"検査値",icon:"🧪"},{id:"scales",label:"スケール（HADS, BIなど）",icon:"📏"},{id:"observation",label:"観察記録",icon:"👁"},{id:"interview",label:"インタビュー",icon:"🎤"},{id:"questionnaire",label:"アンケート（Likert尺度）",icon:"📋"},{id:"intervention",label:"介入有無",icon:"💊"},{id:"timeseries",label:"時系列データ",icon:"📈"},{id:"medical_record",label:"診療記録・カルテ（看護記録や計画など）",icon:"🏥"},{id:"existing_db",label:"既存データベース利用",icon:"🗄"},{id:"other",label:"その他",icon:"✏️"}],pe=[{value:"none",label:"なし（単群・記述的・実態調査など）"},{value:"2groups",label:"2群（ばく露 vs 非ばく露 / 介入 vs 対照 等）"},{value:"3groups",label:"3群以上"},{value:"prepost",label:"前後比較（同一対象への1つの介入前後など）"},{value:"repeated",label:"反復測定・クロスオーバー（同一対象に対する複数の条件・姿勢・時間での測定など）"},{value:"other",label:"その他"}];function Ge(e){const t=a.get("data");e.innerHTML=`
    <div class="fade-in">
      ...
      <div class="card card-highlight" id="dataSummaryPreview">
        ...
        <div id="dataSummaryContent">${ue(t)}</div>
      </div>
    </div>
  `,e.querySelectorAll('#dataTypeGroup input[type="checkbox"]').forEach(i=>{i.addEventListener("change",()=>{const r=Array.from(e.querySelectorAll("#dataTypeGroup input:checked")).map(l=>l.value);a.set("data.types",r),e.querySelectorAll("#dataTypeGroup .checkbox-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#typeOtherWrapper");if(o&&(o.style.display=r.includes("other")?"block":"none",!r.includes("other"))){a.set("data.typeOtherText","");const l=e.querySelector("#typeOtherText");l&&(l.value="")}A()})});const s=e.querySelector("#typeOtherText");s&&s.addEventListener("input",i=>{a.set("data.typeOtherText",i.target.value),A()}),e.querySelector("#sampleSize").addEventListener("input",i=>{a.set("data.sampleSize",i.target.value),A()}),e.querySelectorAll('input[name="grouping"]').forEach(i=>{i.addEventListener("change",r=>{a.set("data.grouping",r.target.value),e.querySelectorAll("#groupingGroup .radio-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#groupingOtherWrapper");if(o&&(o.style.display=r.target.value==="other"?"block":"none",r.target.value!=="other")){a.set("data.groupingOtherText","");const l=e.querySelector("#groupingOtherText");l&&(l.value="")}A()})});const n=e.querySelector("#groupingOtherText");n&&n.addEventListener("input",i=>{a.set("data.groupingOtherText",i.target.value),A()})}function A(){const e=a.get("data"),t=document.querySelector("#dataSummaryContent");t&&(t.innerHTML=ue(e));const s=document.querySelector("#sumData");if(s){const n=e.types||[];if(n.length>0){const i=n.map(r=>{var o;return((o=U.find(l=>l.id===r))==null?void 0:o.label.split("（")[0])||r});s.textContent=i.join("、"),s.classList.add("active")}}}function ue(e){var n;const t=(e.types||[]).map(i=>U.find(r=>r.id===i));let s=((n=pe.find(i=>i.value===e.grouping))==null?void 0:n.label)||"未選択";return e.grouping==="other"&&e.groupingOtherText&&(s+=`（${ae(e.groupingOtherText)}）`),t.length===0&&!e.sampleSize&&!e.grouping?'<p style="color: var(--color-text-muted);">データを選択すると、ここに概要が表示されます。</p>':`
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-4);">
      <div>
        <strong>データタイプ（${t.length}種類）</strong>
        <ul style="margin-top: var(--space-2); padding-left: var(--space-5);">
          ${t.map(i=>{if(!i)return"";let r=i.label;return i.id==="other"&&e.typeOtherText&&(r+=`（${ae(e.typeOtherText)}）`),`<li>${i.icon} ${r}</li>`}).join("")||'<li style="color: var(--color-text-muted);">未選択</li>'}
        </ul>
      </div>
      <div>
  ...
  `,e.querySelector("#btnAnalysis").addEventListener("click",Ue)}function Fe(e){var d,p;const t=e.grouping||"none",s=e.types||[],n=oe[t]||oe.none,i=s.some(u=>["vitals","labs","scales"].includes(u)),r=s.some(u=>["attributes","intervention"].includes(u)),o=s.includes("timeseries"),l=s.some(u=>["interview","observation"].includes(u)),c=[];return i&&c.push(`<li><strong>連続変数の群比較:</strong> ${((d=n.continuous)==null?void 0:d.normal)||n.continuous||"記述統計"}（正規分布を仮定）/ ${((p=n.continuous)==null?void 0:p.nonNormal)||"非パラメトリック検定"}（正規分布でない場合）</li>`),r&&c.push(`<li><strong>カテゴリ変数:</strong> ${n.categorical}</li>`),o&&c.push("<li><strong>時系列分析:</strong> 線形混合モデル（Linear Mixed Model）/ 反復測定分散分析</li>"),l&&c.push("<li><strong>質的データ:</strong> 質的内容分析 / テーマ分析 / グラウンデッドセオリー</li>"),e.sampleSize&&parseInt(e.sampleSize)<30&&c.push('<li style="color: var(--color-warning);"><strong>⚠️ 注意:</strong> サンプルサイズが30未満のため、ノンパラメトリック検定の使用を推奨します</li>'),c.length===0?'<p style="color: var(--color-text-muted);">Step 5でデータを選択すると、自動提案が表示されます。</p>':`<ul style="padding-left: var(--space-5);">${c.join("")}</ul>`}function Ue(){var r;const e=a.get("data"),s=`
研究デザイン: ${a.get("rq.selectedDesign")||""}
データタイプ: ${(e.types||[]).join(", ")}
サンプルサイズ: ${e.sampleSize||"未定"}
群分け: ${e.grouping||"未定"}
  `.trim(),n=`${L.statisticsProposal}

---

${s}`;if(O()){const o=JSON.parse(E.statisticsProposal);a.set("analysis.aiResult",o),document.querySelector("#step6Results").innerHTML=G(o);const l=document.querySelector("#sumAnalysis");l&&(l.textContent=((r=o.primaryAnalysis)==null?void 0:r.method)||"提案済み",l.classList.add("active"));return}const i=document.querySelector("#step6Results");i.innerHTML=T({prompt:n,containerId:"geminiAnalysis",label:"統計分析手法の提案",expectJson:!0,placeholder:"GeminiからのJSON回答をここに貼り付けてください..."}),k(i,n,(o,l)=>{var p;let c;o?c=o:c={primaryAnalysis:{method:"提案結果",reason:l}},a.set("analysis.aiResult",c),i.innerHTML=G(c);const d=document.querySelector("#sumAnalysis");d&&(d.textContent=((p=c.primaryAnalysis)==null?void 0:p.method)||"提案済み",d.classList.add("active"))},!0)}function G(e){var t;return`
    <div class="ai-response">
  ...
  `}function Ke(){return!!a.get("analysis.aiResult")}function We(e){const t=a.get("proposal");e.innerHTML=`
    <div class="fade-in">
  ...
  `,e.querySelector("#btnGenerate").addEventListener("click",Ve),t.draft&&B(t.draft)}function Ye(){var o,l;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),n=a.get("review");a.get("data");const i=a.get("analysis"),r=e.refinedResult;return`
    <div>
      <p><strong>テーマ:</strong> ${r?(r.theme||r.rq||r.title||"未整理").substring(0,80):"未整理"}</p>
      <p><strong>研究デザイン:</strong> ${t.selectedDesign||"未選択"}</p>
      <p><strong>ガイドライン:</strong> ${s.selected||"未選択"}</p>
    </div>
    <div>
      <p><strong>骨子整理:</strong> ${r?"完了":"未完了"}</p>
    ...
    `}function Ve(){var d,p,u,h,v,y,f,b,R,W,Y,V,X,Z,ee,te;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),n=a.get("review"),i=a.get("data"),r=a.get("analysis"),o=`
...
ゴール: ${((v=e.refinedResult)==null?void 0:v.goal)||"未整理"}
アプローチ: ${(((y=e.refinedResult)==null?void 0:y.approaches)||[]).map(g=>`${g.name}: ${g.description}`).join(`
`)}
...
【分析方法】
主解析: ${((R=(b=r.aiResult)==null?void 0:b.primaryAnalysis)==null?void 0:R.method)||"未提案"}
理由: ${((Y=(W=r.aiResult)==null?void 0:W.primaryAnalysis)==null?void 0:Y.reason)||""}
副解析: ${(((V=r.aiResult)==null?void 0:V.secondaryAnalyses)||[]).map(g=>g.method).join(", ")}
効果量: ${((X=r.aiResult)==null?void 0:X.effectSize)||""}
多変量解析: ${(Z=r.aiResult)!=null&&Z.multivariateNeeded?(ee=r.aiResult)==null?void 0:ee.multivariateMethod:"不要"}
サンプルサイズ根拠: ${((te=r.aiResult)==null?void 0:te.sampleSizeNote)||""}
  `.trim(),l=`${L.proposalDraft}

---

${o}`;if(O()){const g=E.proposalDraft;a.set("proposal.draft",g),document.querySelector("#step7Results").innerHTML=j(g),B(g);return}const c=document.querySelector("#step7Results");c.innerHTML=T({prompt:l,containerId:"geminiProposal",label:"研究計画書草案の生成",expectJson:!1,placeholder:"Geminiからの研究計画書草案をここに貼り付けてください..."}),k(c,l,g=>{g&&(a.set("proposal.draft",g),c.innerHTML=j(g),B(g))})}function j(e){return`
    <div class="ai-response">
  ...
  `}function B(e){const t=document.querySelector("#btnCopyProposal");t&&t.addEventListener("click",()=>{navigator.clipboard.writeText(e).then(()=>{t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)}).catch(()=>{const i=document.createElement("textarea");i.value=e,document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)})});const s=document.querySelector("#btnDownloadWord");s&&s.addEventListener("click",()=>{Xe(e)});const n=document.querySelector("#btnDownloadPDF");n&&n.addEventListener("click",()=>{Ze(e)})}function Xe(e){var l,c,d,p;const s=`
<!DOCTYPE html>
...
</html>`,n=new Blob(["\uFEFF"+s],{type:"application/msword;charset=utf-8"}),i=URL.createObjectURL(n),r=document.createElement("a"),o=(((c=(l=a.get("seed"))==null?void 0:l.refinedResult)==null?void 0:c.theme)||((p=(d=a.get("seed"))==null?void 0:d.refinedResult)==null?void 0:p.rq)||"研究計画書").substring(0,30);r.href=i,r.download=`研究計画書草案_${o}.doc`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(i)}function Ze(e){const t=e.replace(/^# (.+)$/gm,"<h1>$1</h1>").replace(/^## (.+)$/gm,"<h2>$1</h2>").replace(/^### (.+)$/gm,"<h3>$1</h3>").replace(/\*\*(.+?)\*\*/g,"<b>$1</b>").replace(/^- (.+)$/gm,"<li>$1</li>").replace(/\n\n/g,"</p><p>").replace(/\n/g,"<br>"),s=window.open("","_blank");s.document.write(`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ${t}
...
</html>`),s.document.close(),setTimeout(()=>{s.print()},500)}function et(){return!!a.get("proposal.draft")}const tt=[{id:1,render:we,validate:Ee},{id:2,render:Te,validate:Ae},{id:3,render:Ie,validate:Pe},{id:4,render:He,validate:Je},{id:5,render:Ge,validate:je},{id:6,render:Be,validate:Ke},{id:7,render:We,validate:et}],st=document.getElementById("stepContent"),it=document.getElementById("progressFill"),me=document.querySelectorAll(".step-tab"),ge=document.getElementById("btnPrev"),x=document.getElementById("btnNext"),nt=document.getElementById("stepIndicator"),q=document.getElementById("settingsModal");let m=a.get("currentStep")||1,le=!1;function ve(){le||(le=!0,a.hasSavedData()&&lt(),P(),z(),ot(),rt(),at(),ct(),K())}function P(){const e=tt.find(t=>t.id===m);e&&e.render(st)}function F(e){e<1||e>7||(m=e,a.set("currentStep",m),P(),z(),window.scrollTo({top:0,behavior:"smooth"}))}function z(){const e=m/7*100;it.style.width=`${e}%`,me.forEach(t=>{const s=parseInt(t.dataset.step);t.classList.toggle("active",s===m),t.classList.toggle("completed",a.get("completedSteps").has(s))}),ge.disabled=m===1,m===7?(x.innerHTML="✅ 完了",x.classList.remove("btn-primary"),x.classList.add("btn-success")):(x.innerHTML=`
      確認して次へ
    ...
    `,x.classList.remove("btn-success"),x.classList.add("btn-primary")),nt.textContent=`Step ${m} / 7`}function rt(){me.forEach(e=>{e.addEventListener("click",()=>{const t=parseInt(e.dataset.step);F(t)})})}function at(){ge.addEventListener("click",()=>{F(m-1)}),x.addEventListener("click",()=>{const e=a.get("completedSteps");e.add(m),a.set("completedSteps",e),m<7&&F(m+1)})}function ot(){const e=document.getElementById("btnSettings"),t=document.getElementById("btnCloseSettings"),s=document.getElementById("btnSaveSettings"),n=document.getElementById("demoModeToggle");n.checked=a.get("demoMode"),e.addEventListener("click",()=>{q.classList.add("visible")}),t.addEventListener("click",()=>{q.classList.remove("visible")}),q.addEventListener("click",i=>{i.target===q&&q.classList.remove("visible")}),s.addEventListener("click",()=>{a.saveDemoMode(n.checked),q.classList.remove("visible"),s.textContent="✅ 保存しました",setTimeout(()=>{s.textContent="保存"},1500)})}function K(){var o,l,c,d,p,u;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),n=a.get("review"),i=a.get("data"),r=a.get("analysis");((o=e.refinedResult)!=null&&o.theme||(l=e.refinedResult)!=null&&l.title||e.question)&&$("Theme",(((c=e.refinedResult)==null?void 0:c.theme)||((d=e.refinedResult)==null?void 0:d.title)||e.question).substring(0,60)),e.refinedResult&&$("RQ",e.refinedResult.rq||e.refinedResult.title),t.selectedDesign&&$("Design",t.selectedDesign),s.selected&&$("Guideline",s.selected),n.aiResult&&$("Literature","背景構築済み"),((p=i.types)==null?void 0:p.length)>0&&$("Data",`${i.types.length}種類のデータ`),(u=r.aiResult)!=null&&u.primaryAnalysis&&$("Analysis",r.aiResult.primaryAnalysis.method)}function $(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function lt(){const e=document.createElement("div");e.className="modal-overlay visible",e.id="resumeDialog",e.innerHTML=`
    ...
    `,document.body.appendChild(e),document.getElementById("btnResume").addEventListener("click",()=>{a.loadFullState(),m=a.get("currentStep")||1,P(),z(),K(),e.remove()}),document.getElementById("btnNewProject").addEventListener("click",()=>{a.reset()})}function ct(){const e=document.getElementById("btnExport"),t=document.getElementById("btnImport"),s=document.getElementById("fileImport");e&&e.addEventListener("click",()=>{a.exportToJSON();const n=e.innerHTML;e.innerHTML="✅ 保存しました",setTimeout(()=>{e.innerHTML=n},2e3)}),t&&s&&(t.addEventListener("click",()=>{s.click()}),s.addEventListener("change",async n=>{const i=n.target.files[0];if(i){try{await a.importFromJSON(i),m=a.get("currentStep")||1,P(),z(),K();const r=t.innerHTML;t.innerHTML="✅ 読み込み完了",setTimeout(()=>{t.innerHTML=r},2e3)}catch(r){alert("ファイルの読み込みに失敗しました: "+r.message)}s.value=""}}))}document.addEventListener("DOMContentLoaded",ve);document.readyState!=="loading"&&ve();
