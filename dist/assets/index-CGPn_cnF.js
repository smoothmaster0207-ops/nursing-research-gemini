...
Ⅴ. 期待される成果
看護師の業務負担を最適化しつつ、患者の安全な在宅移行を実現するためのエビデンスを提示する。`},Re="https://gemini.google.com/app";async function qe(e){try{return await navigator.clipboard.writeText(e),!0}catch{const s=document.createElement("textarea");s.value=e,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select();try{return document.execCommand("copy"),document.body.removeChild(s),!0}catch{return document.body.removeChild(s),!1}}}function Le(){window.open(Re,"_blank","noopener,noreferrer")}function E(e){const{prompt:t,containerId:s,label:r="AI回答",expectJson:i=!1,placeholder:n="Geminiからの回答をここに貼り付けてください..."}=e;return`
...
...(続き)`:""}</div>
    ...
    `}function T(e,t,s,r=!1){const i=e.querySelector(".gemini-copy-btn"),n=e.querySelector(".gemini-open-btn"),o=e.querySelector(".gemini-response-input"),l=e.querySelector(".gemini-submit-btn"),c=e.querySelector(".gemini-copy-feedback");i&&i.addEventListener("click",async()=>{const d=await qe(t);c&&(c.textContent=d?"✅ コピーしました！":"❌ コピーに失敗しました",c.style.opacity="1",setTimeout(()=>{c.style.opacity="0"},2500))}),n&&n.addEventListener("click",()=>{Le()}),o&&l&&(o.addEventListener("input",()=>{l.disabled=!o.value.trim()}),l.addEventListener("click",()=>{const d=o.value.trim();if(d)if(r)try{const u=d.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim(),p=JSON.parse(u);s(p,d)}catch{s(null,d)}else s(d,d)}))}function M(){return a.get("demoMode")}function ke(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ee(e){const t=a.get("seed"),s=t.refinedResult||null;e.innerHTML=`
    <div class="fade-in">
...
`)[0].substring(0,200),t.goal=e.trim(),t):null}function N(e){const t=a.get("seed.rqConfirmed"),s={research:{title:"リサーチクエスチョン",badge:"学術研究"},practice:{title:"実践報告の焦点",badge:"実践報告"},qi:{title:"QIプロジェクト目標",badge:"質改善"}},r=s[e.type]||s.research;return`
  ...
  `}function $(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Ie(){return!!a.get("seed.refinedResult")&&!!a.get("seed.rqConfirmed")}function D(e,t){const s=e.querySelector("#btnConfirmRq"),r=e.querySelector("#refinedRqInput");if(!s||!r)return;const i=()=>{r.style.height="auto",r.style.height=Math.max(80,r.scrollHeight+2)+"px"};requestAnimationFrame(i),setTimeout(i,100),r.addEventListener("input",i),s.addEventListener("click",()=>{r.value.trim()&&(t.rq=r.value.trim(),a.set("seed.refinedResult",t),a.set("seed.rqConfirmed",!0),$("Theme",(t.theme||t.title||t.rq).substring(0,60)),$("RQ",t.rq),e.innerHTML=N(t),D(e,t))})}function Ce(e){const t=a.get("rq"),s=a.get("seed.refinedResult");if(!s){e.innerHTML=`
      <div class="fade-in">
  ...
  `;const o=e.querySelector("#btnGenerateDesign");o?o.addEventListener("click",()=>ge(!1)):r&&j(e)}function ge(e=!1){const t=a.get("seed.refinedResult"),s=a.get("rq.proposalHistory")||[],r=a.get("rq.aiResults");let i=`
...
${i}`;if(M()){const l=JSON.parse(k.designSelection);if(e&&r){const d=[...s,r];a.set("rq.proposalHistory",d)}a.set("rq.aiResults",l),a.set("rq.selectedDesign",null);const c=document.querySelector("#designProposalArea");if(c){const d=a.get("rq.proposalHistory")||[];c.innerHTML=G(l,null,d),j(c)}return}const o=document.querySelector("#designProposalArea");o&&(o.innerHTML=E({prompt:n,containerId:"geminiDesign",label:"研究デザイン提案",expectJson:!1,placeholder:"Geminiが出力した「📋 研究デザイン提案」をここにコピー＆ペーストしてください..."}),T(o,n,(l,c)=>{const d=c||l||"";let u=null;try{const m=d.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"design"\s*:[\s\S]*\}/);if(m){const g=JSON.parse(m[0]);u=ze(g)}}catch{}if(u||(u=Ne(d)),u){if(e&&r){const m=[...s,r];a.set("rq.proposalHistory",m)}a.set("rq.aiResults",u),a.set("rq.selectedDesign",null);const p=a.get("rq.proposalHistory")||[];o.innerHTML=G(u,null,p),j(o)}else alert("提案内容を判読できませんでした。Geminiが出力した「📋 研究デザイン提案」の部分をそのまま貼り付けてください。")}))}function ze(e){return Array.isArray(e)&&(e=e[0]),e.proposals&&(e=e.proposals[0]),{design:e.design||e.title||e.name||"デザイン提案",vision:e.vision||e.description||e.overview||"",finer:e.finer||{},reason:e.reason||e.recommendation||e.rationale||""}}function Ne(e){const t={design:"",vision:"",finer:{},reason:""},s=e.match(/推奨デザイン\s*[:：]\s*(.+?)(?:\n|$)/);s&&(t.design=s[1].trim());const r=e.match(/研究のビジョン\s*[:：]\s*([\s\S]*?)(?=(?:FINER|推奨理由|---|$))/);r&&(t.vision=r[1].trim());const i=e.match(/実現可能性[（(]?F[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);i&&(t.finer.f=i[1].trim());const n=e.match(/面白さ[（(]?I[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);n&&(t.finer.i=n[1].trim());const o=e.match(/新規性[（(]?N[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);o&&(t.finer.n=o[1].trim());const l=e.match(/倫理性[（(]?E[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);l&&(t.finer.e=l[1].trim());const c=e.match(/関連性[（(]?R[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);c&&(t.finer.r=c[1].trim());const d=e.match(/推奨理由\s*[:：]\s*([\s\S]*?)(?=(?:---|✅|📌|$))/);return d&&(t.reason=d[1].trim()),!t.design&&e.trim().length>30&&(t.design=e.trim().split(`
`)[0].substring(0,100)),t.design?t:null}function G(e,t,s){const r=t===e.design,i=De(e.finer);let n="";return s.length>0&&(n=`
  ...
  `}function De(e){if(!e||Object.keys(e).length===0)return"";const s=Object.entries({f:{icon:"✅",label:"実現可能性"},i:{icon:"💡",label:"面白さ"},n:{icon:"🆕",label:"新規性"},e:{icon:"🛡️",label:"倫理性"},r:{icon:"🎯",label:"関連性"}}).map(([r,i])=>{const n=e[r];return!n||n===!0?"":`
    ...
    <div class="fade-in">
      ...
      <div class="card" style="margin-bottom: var(--space-6);">
        ...
        <table class="data-table data-table-selectable" id="designTable">
          ...
          <tbody>
            ${He.map(l=>{const c=(s==null?void 0:s.name)===l.guideline&&t===l.type,d=r&&l.recommendFor.includes(r);return`
  ...
  `:""}function de(e){if(!e)return null;if(I[e])return I[e];for(const[t,s]of Object.entries(I))if(e.includes(t)||t.includes(e))return s;return I.横断研究}function je(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Je(){return!!a.get("guideline.selected")}function Fe(e){return z[e]||[]}function Be(e){const t=a.get("review");e.innerHTML=`
    <div class="fade-in">
  ...
  `;const s=e.querySelector("#reviewKeywords"),r=e.querySelector("#reviewLang"),i=e.querySelector("#reviewContext");s.addEventListener("input",()=>a.set("review.keywords",s.value)),r.addEventListener("change",()=>a.set("review.language",r.value)),i==null||i.addEventListener("change",()=>a.set("review.context",i.value)),e.querySelector("#btnReview").addEventListener("click",We);const n=e.querySelector("#btnSuggestQueries");n&&n.addEventListener("click",Ue),t.suggestedQueries&&J(t.suggestedQueries)}function Ue(){const e=document.querySelector("#suggestedQueriesArea");if(!e)return;const t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",r=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",n=a.get("rq.selectedDesign")||"",o=`
研究テーマ: ${s}
リサーチクエスチョン: ${r}
研究の目的: ${i}
研究デザイン: ${n}
...
${o}`;if(M()){const c=JSON.parse(k.searchQuerySuggestion);a.set("review.suggestedQueries",c),J(c);const d=document.querySelector("#reviewKeywords");if(d&&!d.value.trim()&&c.keywordsJa){const u=c.keywordsJa.join(" ");d.value=u,a.set("review.keywords",u)}return}e.style.display="block",e.innerHTML=E({prompt:l,containerId:"geminiSuggest",label:"検索キーワード・式の提案",expectJson:!1,placeholder:"Geminiが出力した「📋 検索キーワード」をここにコピー＆ペーストしてください..."}),T(e,l,(c,d)=>{const u=d||c||"";let p=null;try{const g=u.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"keywordsJa"[\s\S]*\}/);g&&(p=JSON.parse(g[0]))}catch{}if(p||(p=Ye(u)),p){a.set("review.suggestedQueries",p),J(p);const m=document.querySelector("#reviewKeywords");if(m&&!m.value.trim()&&p.keywordsJa){const f=(Array.isArray(p.keywordsJa)?p.keywordsJa:[p.keywordsJa]).join(" ");m.value=f,a.set("review.keywords",f)}}else e.innerHTML=`
  ...
  `)}function We(){const e=a.get("review"),t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",r=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",n=a.get("rq.selectedDesign")||"",o=a.get("guideline.selected")||"",l=a.get("guideline.notes")||{},c=Fe(o);let d="";if(c.length>0){const g=[],f=[];c.forEach((S,h)=>{const b=l[h];b&&b.trim()?g.push(`✓ ${S}: ${b.trim()}`):f.push(`□ ${S}`)}),g.length>0&&(d+=`
検討済みの項目:
${g.join(`
`)}`),f.length>0&&(d+=`
未検討の項目（文献レビューで補完が必要）:
...
${u}`;if(M()){const g=JSON.parse(k.literatureReview);a.set("review.aiResult",g),document.querySelector("#step4Results").innerHTML=F(g);const f=document.querySelector("#sumLiterature");f&&(f.textContent="背景構築済み",f.classList.add("active"));return}const m=document.querySelector("#step4Results");m.innerHTML=E({prompt:p,containerId:"geminiReview",label:"背景・意義の論理構成",expectJson:!1,placeholder:"Geminiが出力した「📋 研究背景・意義の論理構成案」をここにコピー＆ペーストしてください..."}),T(m,p,(g,f)=>{const S=f||g||"";let h=null;try{const A=S.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"structure"[\s\S]*\}/);A&&(h=JSON.parse(A[0]))}catch{}h||(h={structure:S}),a.set("review.aiResult",h),m.innerHTML=F(h);const b=document.querySelector("#sumLiterature");b&&(b.textContent="背景構築済み",b.classList.add("active"))})}function F(e){return`
    <div class="ai-response">
  ...
  `}function Ke(){return!!a.get("review.aiResult")}function Ye(e){const t={keywordsJa:[],keywordsEn:[],queryJa:"",queryEn:""},s=e.match(/日本語キーワード\s*[:：]\s*(.+?)(?:\n|$)/i);s&&(t.keywordsJa=s[1].split(/[,、，]/).map(o=>o.trim()).filter(o=>o));const r=e.match(/英語キーワード\s*[:：]\s*(.+?)(?:\n|$)/i);r&&(t.keywordsEn=r[1].split(/[,、，]/).map(o=>o.trim()).filter(o=>o));const i=e.match(/日本語検索式\s*[:：]\s*([\s\S]*?)(?=(?:🌍|英語キーワード|英語検索式|---|✅|📌|$))/i);i&&(t.queryJa=i[1].trim());const n=e.match(/英語検索式\s*[:：]\s*([\s\S]*?)(?=(?:---|✅|📌|$))/i);return n&&(t.queryEn=n[1].trim()),t.keywordsJa.length>0||t.keywordsEn.length>0?t:null}const Y=[{id:"attributes",label:"基本属性（年齢・性別など）",icon:"👤"},{id:"vitals",label:"バイタルサイン",icon:"💓"},{id:"labs",label:"検査値",icon:"🧪"},{id:"scales",label:"スケール（HADS, BIなど）",icon:"📏"},{id:"observation",label:"観察記録",icon:"👁"},{id:"interview",label:"インタビュー",icon:"🎤"},{id:"questionnaire",label:"アンケート（Likert尺度）",icon:"📋"},{id:"intervention",label:"介入有無",icon:"💊"},{id:"timeseries",label:"時系列データ",icon:"📈"},{id:"medical_record",label:"診療記録・カルテ（看護記録や計画など）",icon:"🏥"},{id:"existing_db",label:"既存データベース利用",icon:"🗄"},{id:"other",label:"その他",icon:"✏️"}],ve=[{value:"none",label:"なし（単群・記述的・実態調査など）"},{value:"2groups",label:"2群（ばく露 vs 非ばく露 / 介入 vs 対照 等）"},{value:"3groups",label:"3群以上"},{value:"prepost",label:"前後比較（同一対象への1つの介入前後など）"},{value:"repeated",label:"反復測定・クロスオーバー（同一対象に対する複数の条件・姿勢・時間での測定など）"},{value:"other",label:"その他"}];function Ve(e){const t=a.get("data");e.innerHTML=`
    <div class="fade-in">
      ...
      <div class="card card-highlight" id="dataSummaryPreview">
        ...
        <div id="dataSummaryContent">${fe(t)}</div>
      </div>
    </div>
  `,e.querySelectorAll('#dataTypeGroup input[type="checkbox"]').forEach(i=>{i.addEventListener("change",()=>{const n=Array.from(e.querySelectorAll("#dataTypeGroup input:checked")).map(l=>l.value);a.set("data.types",n),e.querySelectorAll("#dataTypeGroup .checkbox-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#typeOtherWrapper");if(o&&(o.style.display=n.includes("other")?"block":"none",!n.includes("other"))){a.set("data.typeOtherText","");const l=e.querySelector("#typeOtherText");l&&(l.value="")}O()})});const s=e.querySelector("#typeOtherText");s&&s.addEventListener("input",i=>{a.set("data.typeOtherText",i.target.value),O()}),e.querySelector("#sampleSize").addEventListener("input",i=>{a.set("data.sampleSize",i.target.value),O()}),e.querySelectorAll('input[name="grouping"]').forEach(i=>{i.addEventListener("change",n=>{a.set("data.grouping",n.target.value),e.querySelectorAll("#groupingGroup .radio-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#groupingOtherWrapper");if(o&&(o.style.display=n.target.value==="other"?"block":"none",n.target.value!=="other")){a.set("data.groupingOtherText","");const l=e.querySelector("#groupingOtherText");l&&(l.value="")}O()})});const r=e.querySelector("#groupingOtherText");r&&r.addEventListener("input",i=>{a.set("data.groupingOtherText",i.target.value),O()})}function O(){const e=a.get("data"),t=document.querySelector("#dataSummaryContent");t&&(t.innerHTML=fe(e));const s=document.querySelector("#sumData");if(s){const r=e.types||[];if(r.length>0){const i=r.map(n=>{var o;return((o=Y.find(l=>l.id===n))==null?void 0:o.label.split("（")[0])||n});s.textContent=i.join("、"),s.classList.add("active")}}}function fe(e){var r;const t=(e.types||[]).map(i=>Y.find(n=>n.id===i));let s=((r=ve.find(i=>i.value===e.grouping))==null?void 0:r.label)||"未選択";return e.grouping==="other"&&e.groupingOtherText&&(s+=`（${pe(e.groupingOtherText)}）`),t.length===0&&!e.sampleSize&&!e.grouping?'<p style="color: var(--color-text-muted);">データを選択すると、ここに概要が表示されます。</p>':`
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-4);">
      <div>
  ...
  `,e.querySelector("#btnAnalysis").addEventListener("click",tt)}function et(e){var d,u;const t=e.grouping||"none",s=e.types||[],r=ue[t]||ue.none,i=s.some(p=>["vitals","labs","scales"].includes(p)),n=s.some(p=>["attributes","intervention"].includes(p)),o=s.includes("timeseries"),l=s.some(p=>["interview","observation"].includes(p)),c=[];return i&&c.push(`<li><strong>連続変数の群比較:</strong> ${((d=r.continuous)==null?void 0:d.normal)||r.continuous||"記述統計"}（正規分布を仮定）/ ${((u=r.continuous)==null?void 0:u.nonNormal)||"非パラメトリック検定"}（正規分布でない場合）</li>`),n&&c.push(`<li><strong>カテゴリ変数:</strong> ${r.categorical}</li>`),o&&c.push("<li><strong>時系列分析:</strong> 線形混合モデル（Linear Mixed Model）/ 反復測定分散分析</li>"),l&&c.push("<li><strong>質的データ:</strong> 質的内容分析 / テーマ分析 / グラウンデッドセオリー</li>"),e.sampleSize&&parseInt(e.sampleSize)<30&&c.push('<li style="color: var(--color-warning);"><strong>⚠️ 注意:</strong> サンプルサイズが30未満のため、ノンパラメトリック検定の使用を推奨します</li>'),c.length===0?'<p style="color: var(--color-text-muted);">Step 5でデータを選択すると、自動提案が表示されます。</p>':`<ul style="padding-left: var(--space-5);">${c.join("")}</ul>`}function tt(){var n;const e=a.get("data"),s=`
...
`)[0].substring(0,100),t.primaryAnalysis.reason=e.trim(),t):null}function B(e){var t;return`
  ...
  `}function it(){return!!a.get("analysis.aiResult")}function nt(e){const t=a.get("proposal");e.innerHTML=`
    <div class="fade-in">
  ...
  `,e.querySelector("#btnGenerate").addEventListener("click",at),t.draft&&W(t.draft)}function rt(){var o,l;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review");a.get("data");const i=a.get("analysis"),n=e.refinedResult;return`
    <div>
    ...
    `}function at(){var g,f,S,h,b,C,A,X,Z,ee,te,se,ie,ne,re,ae;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review"),i=a.get("data"),n=a.get("analysis"),o=s.selected||"",l=s.notes||{},c=z[o]||[];let d="";if(c.length>0){const v=[];c.forEach((Se,$e)=>{const _=l[$e];_&&_.trim()&&v.push(`  ✓ ${Se}: ${_.trim()}`)}),v.length>0&&(d=`
...
${u}`;if(M()){const v=k.proposalDraft;a.set("proposal.draft",v),document.querySelector("#step7Results").innerHTML=U(v),W(v);return}const m=document.querySelector("#step7Results");m.innerHTML=E({prompt:p,containerId:"geminiProposal",label:"研究計画書草案の生成",expectJson:!1,placeholder:"Geminiからの研究計画書草案をここに貼り付けてください..."}),T(m,p,v=>{v&&(a.set("proposal.draft",v),m.innerHTML=U(v),W(v))})}function ot(e){const t="display:inline-block;background:#fff3cd;color:#856404;font-size:0.7rem;padding:1px 6px;border-radius:3px;margin-left:4px;font-weight:bold;vertical-align:middle;border:1px solid #f0c36d;",s={lit:`<span style="${t}" title="文献を自身で検索し、実在を確認してください">⚠️文献要確認</span>`,stat:`<span style="${t}" title="統計の専門家に妥当性を確認してください">⚠️統計要確認</span>`,sample:`<span style="${t}" title="サンプルサイズの計算根拠を自身で検証してください">⚠️要検証</span>`,ethics:`<span style="${t}" title="施設の倫理審査要件に合わせて修正してください">⚠️施設に合わせて修正</span>`,citation:`<span style="${t}background:#f8d7da;color:#721c24;border-color:#f5c6cb;" title="実在する文献に差し替えてください">🔴出典未確認</span>`};let r=0;const i=n=>(r++,n);return e=e.replace(/出典確認中/g,()=>i(`出典確認中 ${s.citation}`)),e=e.replace(/(先行研究によ(?:れば|ると))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/(既存の(?:エビデンス|研究|知見)(?:では|によ(?:れば|ると)))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/((?:国内外の|複数の|多くの|近年の)(?:研究|報告|調査)(?:では|で|が|において))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/((?:メタアナリシス|システマティックレビュー)(?:では|によ(?:れば|ると)))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/(t検定|χ²検定|カイ二乗検定|Mann-Whitney|Wilcoxon|ANOVA|分散分析|ロジスティック回帰|Cox比例ハザード|Kaplan-Meier|ログランク検定|線形混合モデル|共分散分析|因子分析|主成分分析|構造方程式)/g,n=>i(`${n} ${s.stat}`)),e=e.replace(/((?:サンプルサイズ|標本サイズ|症例数)(?:は|を|の)[^<]{5,60}?(?:名|例|人|とする|と設定|を目標))/g,n=>i(`${n} ${s.sample}`)),e=e.replace(/(インフォームド・コンセント)/g,n=>i(`${n} ${s.ethics}`)),e=e.replace(/(倫理審査委員会(?:の承認|に申請|の審査))/g,n=>i(`${n} ${s.ethics}`)),{html:e,count:r,tags:s}}function U(e){let t=e.replace(/^# (.+)$/gm,'<h2 style="margin-top: var(--space-6); color: var(--color-primary-dark); border-bottom: 2px solid var(--color-primary-border); padding-bottom: var(--space-2);">$1</h2>').replace(/^## (.+)$/gm,'<h3 style="margin-top: var(--space-5); color: var(--color-text);">$1</h3>').replace(/^### (.+)$/gm,'<h4 style="margin-top: var(--space-4); color: var(--color-text-secondary);">$1</h4>').replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/^- (.+)$/gm,"<li>$1</li>").replace(/\n\n/g,"</p><p>").replace(/\n/g,"<br>");const{html:s,count:r,tags:i}=ot(t);return t=s,`
    <div class="ai-response">
  ...
  `}function W(e){const t=document.querySelector("#btnCopyProposal");t&&t.addEventListener("click",()=>{navigator.clipboard.writeText(e).then(()=>{t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)}).catch(()=>{const i=document.createElement("textarea");i.value=e,document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)})});const s=document.querySelector("#btnDownloadWord");s&&s.addEventListener("click",()=>{lt(e)});const r=document.querySelector("#btnDownloadPDF");r&&r.addEventListener("click",()=>{ct(e)})}function lt(e){var l,c,d,u;const s=`
<!DOCTYPE html>
...
<body>
  ${t}
...
</html>`),s.document.close(),setTimeout(()=>{s.print()},500)}function dt(){return!!a.get("proposal.draft")}const pt=[{id:1,render:Ee,validate:Ie},{id:2,render:Ce,validate:Pe},{id:3,render:_e,validate:Je},{id:4,render:Be,validate:Ke},{id:5,render:Ve,validate:Xe},{id:6,render:Ze,validate:it},{id:7,render:nt,validate:dt}],ut=document.getElementById("stepContent"),mt=document.getElementById("progressFill"),ye=document.querySelectorAll(".step-tab"),he=document.getElementById("btnPrev"),R=document.getElementById("btnNext"),gt=document.getElementById("stepIndicator"),q=document.getElementById("settingsModal");let y=a.get("currentStep")||1,me=!1;function be(){me||(me=!0,a.hasSavedData()&&ht(),P(),H(),yt(),vt(),ft(),bt(),V())}function P(){const e=pt.find(t=>t.id===y);e&&e.render(ut)}function K(e){e<1||e>7||(y=e,a.set("currentStep",y),P(),H(),window.scrollTo({top:0,behavior:"smooth"}))}function H(){const e=y/7*100;mt.style.width=`${e}%`,ye.forEach(t=>{const s=parseInt(t.dataset.step);t.classList.toggle("active",s===y),t.classList.toggle("completed",a.get("completedSteps").has(s))}),he.disabled=y===1,y===7?(R.innerHTML="✅ 完了",R.classList.remove("btn-primary"),R.classList.add("btn-success")):(R.innerHTML=`
      確認して次へ
    ...
    `,document.body.appendChild(e),document.getElementById("btnResume").addEventListener("click",()=>{a.loadFullState(),y=a.get("currentStep")||1,P(),H(),V(),e.remove()}),document.getElementById("btnNewProject").addEventListener("click",()=>{a.reset()})}function bt(){const e=document.getElementById("btnExport"),t=document.getElementById("btnImport"),s=document.getElementById("fileImport");e&&e.addEventListener("click",()=>{a.exportToJSON();const r=e.innerHTML;e.innerHTML="✅ 保存しました",setTimeout(()=>{e.innerHTML=r},2e3)}),t&&s&&(t.addEventListener("click",()=>{s.click()}),s.addEventListener("change",async r=>{const i=r.target.files[0];if(i){try{await a.importFromJSON(i),y=a.get("currentStep")||1,P(),H(),V();const n=t.innerHTML;t.innerHTML="✅ 読み込み完了",setTimeout(()=>{t.innerHTML=n},2e3)}catch(n){alert("ファイルの読み込みに失敗しました: "+n.message)}s.value=""}}))}document.addEventListener("DOMContentLoaded",be);document.readyState!=="loading"&&be();
