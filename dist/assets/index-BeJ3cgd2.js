...
Ⅴ. 期待される成果
看護師の業務負担を最適化しつつ、患者の安全な在宅移行を実現するためのエビデンスを提示する。`},xe="https://gemini.google.com/app";async function qe(e){try{return await navigator.clipboard.writeText(e),!0}catch{const s=document.createElement("textarea");s.value=e,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select();try{return document.execCommand("copy"),document.body.removeChild(s),!0}catch{return document.body.removeChild(s),!1}}}function Le(){window.open(xe,"_blank","noopener,noreferrer")}function T(e){const{prompt:t,containerId:s,label:r="AI回答",expectJson:i=!1,placeholder:n="Geminiからの回答をここに貼り付けてください..."}=e;return`
...
...(続き)`:""}</div>
  ...
  `;const r=e.querySelector("#seedQuestion"),i=e.querySelector("#btnStartChat"),n=e.querySelector("#privacyModal"),o=e.querySelector("#btnOpenPrivacyModal"),l=e.querySelector("#btnClosePrivacyModal");if(o&&o.addEventListener("click",()=>{n.classList.add("visible")}),l&&l.addEventListener("click",()=>{n.classList.remove("visible")}),n&&n.addEventListener("click",c=>{c.target===n&&n.classList.remove("visible")}),r.addEventListener("input",()=>{a.set("seed.question",r.value),i.disabled=!r.value.trim()}),i.addEventListener("click",()=>{ke(r.value);const c=e.querySelector("#geminiArea");c&&c.scrollIntoView({behavior:"smooth"})}),s){const c=e.querySelector("#refinedResultArea");z(c,s),$("Theme",(s.theme||s.rq||"").substring(0,60)),$("RQ",s.rq||"")}}function ke(e){const t=`${L.rqAssistant}

---

【ユーザーからの研究の種】
${e}`,s=document.querySelector("#geminiChatUI");if(s){if(M()){Me();return}s.innerHTML=T({prompt:t,containerId:"geminiChat",label:"ブレインストーミング（研究の種の整理）",expectJson:!1,placeholder:"Geminiが出力した「📋 研究の骨子」をここにコピー＆ペーストしてください..."}),k(s,t,r=>{if(r){const i=r||"";let n=Ae(i);if(n||(n=Oe(i)),n){a.set("seed.refinedResult",n);const o=document.querySelector("#refinedResultArea");o&&(o.classList.remove("hidden"),o.innerHTML=D(n),z(o,n),o.scrollIntoView({behavior:"smooth"})),$("Theme",(n.theme||n.rq||"").substring(0,60)),$("RQ",n.rq||""),s.innerHTML=`
...
`)[0].substring(0,200),t.goal=e.trim(),t):null}function D(e){const t=a.get("seed.rqConfirmed"),s={research:{title:"リサーチクエスチョン",badge:"学術研究"},practice:{title:"実践報告の焦点",badge:"実践報告"},qi:{title:"QIプロジェクト目標",badge:"質改善"}},r=s[e.type]||s.research;return`
  ...
  `}function $(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Ie(){return!!a.get("seed.refinedResult")&&!!a.get("seed.rqConfirmed")}function z(e,t){const s=e.querySelector("#btnConfirmRq"),r=e.querySelector("#refinedRqInput");if(!s||!r)return;const i=()=>{r.style.height="auto",r.style.height=Math.max(80,r.scrollHeight+2)+"px"};requestAnimationFrame(i),setTimeout(i,100),r.addEventListener("input",i),s.addEventListener("click",()=>{r.value.trim()&&(t.rq=r.value.trim(),a.set("seed.refinedResult",t),a.set("seed.rqConfirmed",!0),$("Theme",(t.theme||t.title||t.rq).substring(0,60)),$("RQ",t.rq),e.innerHTML=D(t),z(e,t))})}function Ce(e){const t=a.get("rq"),s=a.get("seed.refinedResult");if(!s){e.innerHTML=`
      <div class="fade-in">
...
`)[0].substring(0,100)),t.design?t:null}function G(e,t,s){const r=t===e.design,i=ze(e.finer);let n="";return s.length>0&&(n=`
  ...
  `}function ze(e){if(!e||Object.keys(e).length===0)return"";const s=Object.entries({f:{icon:"✅",label:"実現可能性"},i:{icon:"💡",label:"面白さ"},n:{icon:"🆕",label:"新規性"},e:{icon:"🛡️",label:"倫理性"},r:{icon:"🎯",label:"関連性"}}).map(([r,i])=>{const n=e[r];return!n||n===!0?"":`
  ...
  `:""}function de(e){if(!e)return null;if(I[e])return I[e];for(const[t,s]of Object.entries(I))if(e.includes(t)||t.includes(e))return s;return I.横断研究}function je(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Je(){return!!a.get("guideline.selected")}function Fe(e){return N[e]||[]}function Be(e){const t=a.get("review");e.innerHTML=`
    <div class="fade-in">
...
`)[0].substring(0,100),t.primaryAnalysis.reason=e.trim(),t):null}function B(e){var t;return`
  ...
  `,e.querySelector("#btnGenerate").addEventListener("click",at),t.draft&&W(t.draft)}function rt(){var o,l;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review");a.get("data");const i=a.get("analysis"),n=e.refinedResult;return`
    ...
    `}function at(){var g,h,S,f,b,C,A,X,Z,ee,te,se,ie,ne,re,ae;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review"),i=a.get("data"),n=a.get("analysis"),o=s.selected||"",l=s.notes||{},c=N[o]||[];let d="";if(c.length>0){const v=[];c.forEach((Se,$e)=>{const _=l[$e];_&&_.trim()&&v.push(`  ✓ ${Se}: ${_.trim()}`)}),v.length>0&&(d=`
...
${u}`;if(M()){const v=E.proposalDraft;a.set("proposal.draft",v),document.querySelector("#step7Results").innerHTML=U(v),W(v);return}const m=document.querySelector("#step7Results");m.innerHTML=T({prompt:p,containerId:"geminiProposal",label:"研究計画書草案の生成",expectJson:!1,placeholder:"Geminiからの研究計画書草案をここに貼り付けてください..."}),k(m,p,v=>{v&&(a.set("proposal.draft",v),m.innerHTML=U(v),W(v))})}function U(e){return`
    <div class="ai-response">
