...
Ⅴ. 期待される成果
看護師の業務負担を最適化しつつ、患者の安全な在宅移行を実現するためのエビデンスを提示する。`},Te="https://gemini.google.com/app";async function Me(e){try{return await navigator.clipboard.writeText(e),!0}catch{const s=document.createElement("textarea");s.value=e,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select();try{return document.execCommand("copy"),document.body.removeChild(s),!0}catch{return document.body.removeChild(s),!1}}}function Ae(){window.open(Te,"_blank","noopener,noreferrer")}function E(e){const{prompt:t,containerId:s,label:r="AI回答",expectJson:i=!1,placeholder:n="Geminiからの回答をここに貼り付けてください..."}=e;return`
...
...(続き)`:""}</div>
    ...
    `}function T(e,t,s,r=!1){const i=e.querySelector(".gemini-copy-btn"),n=e.querySelector(".gemini-open-btn"),o=e.querySelector(".gemini-response-input"),l=e.querySelector(".gemini-submit-btn"),c=e.querySelector(".gemini-copy-feedback");i&&i.addEventListener("click",async()=>{const d=await Me(t);c&&(c.textContent=d?"✅ コピーしました！":"❌ コピーに失敗しました",c.style.opacity="1",setTimeout(()=>{c.style.opacity="0"},2500))}),n&&n.addEventListener("click",()=>{Ae()}),o&&l&&(o.addEventListener("input",()=>{l.disabled=!o.value.trim()}),l.addEventListener("click",()=>{const d=o.value.trim();if(d)if(r)try{const u=d.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim(),p=JSON.parse(u);s(p,d)}catch{s(null,d)}else s(d,d)}))}function M(){return a.get("demoMode")}function Ie(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Oe(e){const t=a.get("seed"),s=t.refinedResult||null;e.innerHTML=`
    <div class="fade-in">
  ...
  `;const r=e.querySelector("#seedQuestion"),i=e.querySelector("#btnStartChat"),n=e.querySelector("#privacyModal"),o=e.querySelector("#btnOpenPrivacyModal"),l=e.querySelector("#btnClosePrivacyModal");if(o&&o.addEventListener("click",()=>{n.classList.add("visible")}),l&&l.addEventListener("click",()=>{n.classList.remove("visible")}),n&&n.addEventListener("click",c=>{c.target===n&&n.classList.remove("visible")}),r.addEventListener("input",()=>{a.set("seed.question",r.value),i.disabled=!r.value.trim()}),i.addEventListener("click",()=>{Ce(r.value);const c=e.querySelector("#geminiArea");c&&c.scrollIntoView({behavior:"smooth"})}),s){const c=e.querySelector("#refinedResultArea");N(c,s),$("Theme",(s.theme||s.rq||"").substring(0,60)),$("RQ",s.rq||"")}}function Ce(e){const t=`${k.rqAssistant}

---

【ユーザーからの研究の種】
${e}`,s=document.querySelector("#geminiChatUI");if(s){if(M()){ze();return}s.innerHTML=E({prompt:t,containerId:"geminiChat",label:"ブレインストーミング（研究の種の整理）",expectJson:!1,placeholder:"Geminiが出力した「📋 研究の骨子」をここにコピー＆ペーストしてください..."}),T(s,t,r=>{if(r){const i=r||"";let n=De(i);if(n||(n=Ne(i)),n){a.set("seed.refinedResult",n);const o=document.querySelector("#refinedResultArea");o&&(o.classList.remove("hidden"),o.innerHTML=D(n),N(o,n),o.scrollIntoView({behavior:"smooth"})),$("Theme",(n.theme||n.rq||"").substring(0,60)),$("RQ",n.rq||""),s.innerHTML=`
        ...
        `}else alert("骨子の内容を判読できませんでした。Geminiが出力した「📋 研究の骨子」の部分をそのまま貼り付けてください。")}})}}function ze(e){const t=JSON.parse(L.rqOverview);a.set("seed.refinedResult",t);const s=document.querySelector("#geminiChatUI");s&&(s.innerHTML=`
      <div class="card" style="background: #f0fdf4; border: 1px solid #86efac; text-align: center; padding: var(--space-4);">
        <p style="color: #166534; font-weight: 600; margin: 0;">✅ デモモード：研究の骨子を自動生成しました。下の内容を確認してください。</p>
      </div>
    `);const r=document.querySelector("#refinedResultArea");r&&(r.classList.remove("hidden"),r.innerHTML=D(t),N(r,t)),$("Theme",(t.theme||t.rq||"").substring(0,60)),$("RQ",t.rq||"")}function De(e){try{const s=e.replace(/```json\s*\n?/g,"").replace(/```\s*\n?/g,"").trim().match(/\{[\s\S]*\}/);if(s){const r=JSON.parse(s[0]);if(r.rq||r.theme||r.type)return r}}catch{}return null}function Ne(e){const t={type:"research",theme:"",rq:"",target:"",goal:"",approaches:[]},s=e.match(/リサーチクエスチョン[（(]?RQ[)）]?\s*[:：]\s*(.+?)(?:\n|$)/i)||e.match(/RQ\s*[:：]\s*(.+?)(?:\n|$)/i);s&&(t.rq=s[1].trim());const r=e.match(/研究デザイン\s*[:：]\s*(.+?)(?:\n|$)/);r&&(t.theme=r[1].trim());const i=e.match(/対象\s*[:：]\s*(.+?)(?:\n|$)/);i&&(t.target=i[1].trim());const n=e.match(/最終ゴール\s*[:：]\s*(.+?)(?:\n|$)/);n&&(t.goal=n[1].trim()),!t.theme&&t.rq&&(t.theme=t.rq.replace(/[？?]$/,"").substring(0,60));const o=e.matchAll(/(?:量的|質的|STEP\s*\d+|フェーズ)[^:：]*[:：]\s*([\s\S]*?)(?=(?:量的|質的|STEP\s*\d+|フェーズ|最終ゴール|---|\n\n|$))/gi);for(const l of o){const c=l[0].trim(),d=c.match(/^(.+?)[:：]/);d&&t.approaches.push({name:d[1].trim(),description:c.substring(d[0].length).trim().replace(/\n/g," ").substring(0,200)})}return t.rq?t:e.trim().length>30?(t.rq=e.trim().split(`
`)[0].substring(0,200),t.goal=e.trim(),t):null}function D(e){const t=a.get("seed.rqConfirmed"),s={research:{title:"リサーチクエスチョン",badge:"学術研究"},practice:{title:"実践報告の焦点",badge:"実践報告"},qi:{title:"QIプロジェクト目標",badge:"質改善"}},r=s[e.type]||s.research;return`
  ...
  `}function $(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function Pe(){return!!a.get("seed.refinedResult")&&!!a.get("seed.rqConfirmed")}function N(e,t){const s=e.querySelector("#btnConfirmRq"),r=e.querySelector("#refinedRqInput");if(!s||!r)return;const i=()=>{r.style.height="auto",r.style.height=Math.max(80,r.scrollHeight+2)+"px"};requestAnimationFrame(i),setTimeout(i,100),r.addEventListener("input",i),s.addEventListener("click",()=>{r.value.trim()&&(t.rq=r.value.trim(),a.set("seed.refinedResult",t),a.set("seed.rqConfirmed",!0),$("Theme",(t.theme||t.title||t.rq).substring(0,60)),$("RQ",t.rq),e.innerHTML=D(t),N(e,t))})}function He(e){const t=a.get("rq"),s=a.get("seed.refinedResult");if(!s){e.innerHTML=`
      <div class="fade-in">
  ...
  `;const o=e.querySelector("#btnGenerateDesign");o?o.addEventListener("click",()=>be(!1)):r&&Q(e)}function be(e=!1){const t=a.get("seed.refinedResult"),s=a.get("rq.proposalHistory")||[],r=a.get("rq.aiResults");let i=`
...
`)}`}const n=`${k.designSelection}

---

${i}`;if(M()){const l=JSON.parse(L.designSelection);if(e&&r){const d=[...s,r];a.set("rq.proposalHistory",d)}a.set("rq.aiResults",l),a.set("rq.selectedDesign",null);const c=document.querySelector("#designProposalArea");if(c){const d=a.get("rq.proposalHistory")||[];c.innerHTML=G(l,null,d),Q(c)}return}const o=document.querySelector("#designProposalArea");o&&(o.innerHTML=E({prompt:n,containerId:"geminiDesign",label:"研究デザイン提案",expectJson:!1,placeholder:"Geminiが出力した「📋 研究デザイン提案」をここにコピー＆ペーストしてください..."}),T(o,n,(l,c)=>{const d=c||l||"";let u=null;try{const m=d.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"design"\s*:[\s\S]*\}/);if(m){const g=JSON.parse(m[0]);u=_e(g)}}catch{}if(u||(u=je(d)),u){if(e&&r){const m=[...s,r];a.set("rq.proposalHistory",m)}a.set("rq.aiResults",u),a.set("rq.selectedDesign",null);const p=a.get("rq.proposalHistory")||[];o.innerHTML=G(u,null,p),Q(o)}else alert("提案内容を判読できませんでした。Geminiが出力した「📋 研究デザイン提案」の部分をそのまま貼り付けてください。")}))}function _e(e){return Array.isArray(e)&&(e=e[0]),e.proposals&&(e=e.proposals[0]),{design:e.design||e.title||e.name||"デザイン提案",vision:e.vision||e.description||e.overview||"",finer:e.finer||{},reason:e.reason||e.recommendation||e.rationale||""}}function je(e){e=e.replace(/\*\*(.+?)\*\*/g,"$1").replace(/^[-•]\s*/gm,"").replace(/^\d+\.\s*/gm,"");const t={design:"",vision:"",finer:{},reason:""},s=e.match(/推奨デザイン\s*[:：]\s*(.+?)(?:\n|$)/);s&&(t.design=s[1].trim());const r=e.match(/研究のビジョン\s*[:：]\s*([\s\S]*?)(?=(?:FINER|推奨理由|---|$))/);r&&(t.vision=r[1].trim());const i=e.match(/実現可能性[（(]?F[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);i&&(t.finer.f=i[1].trim());const n=e.match(/面白さ[（(]?I[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);n&&(t.finer.i=n[1].trim());const o=e.match(/新規性[（(]?N[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);o&&(t.finer.n=o[1].trim());const l=e.match(/倫理性[（(]?E[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);l&&(t.finer.e=l[1].trim());const c=e.match(/関連性[（(]?R[)）]?\s*[:：]\s*(.+?)(?:\n|$)/);c&&(t.finer.r=c[1].trim());const d=e.match(/推奨理由\s*[:：]\s*([\s\S]*?)(?=(?:---|✅|📌|$))/);return d&&(t.reason=d[1].trim()),!t.design&&e.trim().length>30&&(t.design=e.trim().split(`
`)[0].substring(0,100)),t.design?t:null}function G(e,t,s){const r=t===e.design,i=Ge(e.finer);let n="";return s.length>0&&(n=`
  ...
  `}function Ge(e){if(!e||Object.keys(e).length===0)return"";const s=Object.entries({f:{icon:"✅",label:"実現可能性"},i:{icon:"💡",label:"面白さ"},n:{icon:"🆕",label:"新規性"},e:{icon:"🛡️",label:"倫理性"},r:{icon:"🎯",label:"関連性"}}).map(([r,i])=>{const n=e[r];return!n||n===!0?"":`
    ...
    <div class="fade-in">
      ...
      <div class="card" style="margin-bottom: var(--space-6);">
        ...
        <table class="data-table data-table-selectable" id="designTable">
          ...
          <tbody>
            ${Je.map(l=>{const c=(s==null?void 0:s.name)===l.guideline&&t===l.type,d=r&&l.recommendFor.includes(r);return`
  ...
  `,s&&me(s.name),e.querySelectorAll("#designTable tbody tr").forEach(l=>{l.addEventListener("click",()=>{const c=l.dataset.type;l.dataset.guideline,a.set("rq.selectedDesign",c),a.set("guideline.checklist",[]),a.set("guideline.notes",{});const d=O[c]||ge(c);d&&a.set("guideline.selected",d.name),e.querySelectorAll("#designTable tbody tr").forEach(p=>{p.classList.remove("selected-row");const m=p.querySelector("td:last-child");m&&(m.innerHTML="")}),l.classList.add("selected-row");const u=l.querySelector("td:last-child");if(u&&(u.innerHTML='<span class="tag tag-primary">✓ 選択中</span>'),d){const p=e.querySelector("#guidelineDetailArea"),m=z[d.name]||[];p.innerHTML=pe(d,m,{}),ue(e),me(d.name)}Ke("Design",c)})}),ue(e)}function pe(e,t,s){const r=Object.values(s).filter(i=>i&&i.trim()).length;return`
  ...
  `:""}function ge(e){if(!e)return null;if(O[e])return O[e];for(const[t,s]of Object.entries(O))if(e.includes(t)||t.includes(e))return s;return O.横断研究}function Ke(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function We(){return!!a.get("guideline.selected")}function Ye(e){return z[e]||[]}function Ve(e){const t=a.get("review");e.innerHTML=`
    <div class="fade-in">
      ...
      <div id="step4Results">
        ${t.aiResult?B(t.aiResult):""}
      </div>
    </div>
  `;const s=e.querySelector("#reviewKeywords"),r=e.querySelector("#reviewLang"),i=e.querySelector("#reviewContext");s.addEventListener("input",()=>a.set("review.keywords",s.value)),r.addEventListener("change",()=>a.set("review.language",r.value)),i==null||i.addEventListener("change",()=>a.set("review.context",i.value)),e.querySelector("#btnReview").addEventListener("click",Ze);const n=e.querySelector("#btnSuggestQueries");n&&n.addEventListener("click",Xe),t.suggestedQueries&&J(t.suggestedQueries)}function Xe(){const e=document.querySelector("#suggestedQueriesArea");if(!e)return;const t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",r=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",n=a.get("rq.selectedDesign")||"",o=`
研究テーマ: ${s}
リサーチクエスチョン: ${r}
研究の目的: ${i}
研究デザイン: ${n}
  `.trim(),l=`${k.searchQuerySuggestion}

---

${o}`;if(M()){const c=JSON.parse(L.searchQuerySuggestion);a.set("review.suggestedQueries",c),J(c);const d=document.querySelector("#reviewKeywords");if(d&&!d.value.trim()&&c.keywordsJa){const u=c.keywordsJa.join(" ");d.value=u,a.set("review.keywords",u)}return}e.style.display="block",e.innerHTML=E({prompt:l,containerId:"geminiSuggest",label:"検索キーワード・式の提案",expectJson:!1,placeholder:"Geminiが出力した「📋 検索キーワード」をここにコピー＆ペーストしてください..."}),T(e,l,(c,d)=>{const u=d||c||"";let p=null;try{const g=u.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"keywordsJa"[\s\S]*\}/);g&&(p=JSON.parse(g[0]))}catch{}if(p||(p=tt(u)),p){a.set("review.suggestedQueries",p),J(p);const m=document.querySelector("#reviewKeywords");if(m&&!m.value.trim()&&p.keywordsJa){const y=(Array.isArray(p.keywordsJa)?p.keywordsJa:[p.keywordsJa]).join(" ");m.value=y,a.set("review.keywords",y)}}else e.innerHTML=`
        <div class="card" style="border-color: var(--color-danger);">
          <p style="color: var(--color-danger);">⚠️ 回答を判読できませんでした。Geminiの回答をそのまま貼り付けてください。</p>
        </div>
      `})}function J(e){const t=document.querySelector("#suggestedQueriesArea");if(!t)return;const s=(e.keywordsJa||[]).join(" "),r=(e.keywordsEn||[]).join(" "),i=`https://pubmed.ncbi.nlm.nih.gov/?term=${encodeURIComponent(r)}`,n=`https://scholar.google.com/scholar?q=${encodeURIComponent(r)}`,o=`https://cir.nii.ac.jp/all?q=${encodeURIComponent(s)}`,l=`https://www.jstage.jst.go.jp/result/global/-char/ja?globalSearchKey=${encodeURIComponent(s)}`,c="display:inline-flex;align-items:center;gap:4px;padding:4px 10px;border-radius:4px;font-size:0.78rem;text-decoration:none;border:1px solid;margin-top:6px;margin-right:6px;font-weight:500;";t.style.display="block",t.innerHTML=`
  ...
  `}function Ze(){const e=a.get("review"),t=a.get("seed.refinedResult"),s=(t==null?void 0:t.rq)||(t==null?void 0:t.title)||"",r=(t==null?void 0:t.goal)||"",i=(t==null?void 0:t.goal)||"",n=a.get("rq.selectedDesign")||"",o=a.get("guideline.selected")||"",l=a.get("guideline.notes")||{},c=Ye(o);let d="";if(c.length>0){const g=[],y=[];c.forEach((S,h)=>{const b=l[h];b&&b.trim()?g.push(`✓ ${S}: ${b.trim()}`):y.push(`□ ${S}`)}),g.length>0&&(d+=`
検討済みの項目:
${g.join(`
`)}`),y.length>0&&(d+=`
未検討の項目（文献レビューで補完が必要）:
...
${d}
  `.trim(),p=`${k.literatureReview}

---

${u}`;if(M()){const g=JSON.parse(L.literatureReview);a.set("review.aiResult",g),document.querySelector("#step4Results").innerHTML=B(g);const y=document.querySelector("#sumLiterature");y&&(y.textContent="背景構築済み",y.classList.add("active"));return}const m=document.querySelector("#step4Results");m.innerHTML=E({prompt:p,containerId:"geminiReview",label:"背景・意義の論理構成",expectJson:!1,placeholder:"Geminiが出力した「📋 研究背景・意義の論理構成案」をここにコピー＆ペーストしてください..."}),T(m,p,(g,y)=>{const S=y||g||"";let h=null;try{const A=S.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"structure"[\s\S]*\}/);A&&(h=JSON.parse(A[0]))}catch{}h||(h={structure:S}),a.set("review.aiResult",h),m.innerHTML=B(h);const b=document.querySelector("#sumLiterature");b&&(b.textContent="背景構築済み",b.classList.add("active"))})}function B(e){return`
    <div class="ai-response">
  ...
  `}function et(){return!!a.get("review.aiResult")}function tt(e){e=e.replace(/\*\*(.+?)\*\*/g,"$1").replace(/^[-•]\s*/gm,"").replace(/^\d+\.\s*/gm,"");const t={keywordsJa:[],keywordsEn:[],queryJa:"",queryEn:""},s=e.match(/日本語キーワード\s*[:：]\s*(.+?)(?:\n|$)/i);s&&(t.keywordsJa=s[1].split(/[,、，]/).map(o=>o.trim()).filter(o=>o));const r=e.match(/英語キーワード\s*[:：]\s*(.+?)(?:\n|$)/i);r&&(t.keywordsEn=r[1].split(/[,、，]/).map(o=>o.trim()).filter(o=>o));const i=e.match(/日本語検索式\s*[:：]\s*([\s\S]*?)(?=(?:🌍|英語キーワード|英語検索式|---|✅|📌|$))/i);i&&(t.queryJa=i[1].trim());const n=e.match(/英語検索式\s*[:：]\s*([\s\S]*?)(?=(?:---|✅|📌|$))/i);return n&&(t.queryEn=n[1].trim()),t.keywordsJa.length>0||t.keywordsEn.length>0?t:null}const Y=[{id:"attributes",label:"基本属性（年齢・性別など）",icon:"👤"},{id:"vitals",label:"バイタルサイン",icon:"💓"},{id:"labs",label:"検査値",icon:"🧪"},{id:"scales",label:"スケール（HADS, BIなど）",icon:"📏"},{id:"observation",label:"観察記録",icon:"👁"},{id:"interview",label:"インタビュー",icon:"🎤"},{id:"questionnaire",label:"アンケート（Likert尺度）",icon:"📋"},{id:"intervention",label:"介入有無",icon:"💊"},{id:"timeseries",label:"時系列データ",icon:"📈"},{id:"medical_record",label:"診療記録・カルテ（看護記録や計画など）",icon:"🏥"},{id:"existing_db",label:"既存データベース利用",icon:"🗄"},{id:"other",label:"その他",icon:"✏️"}],Se=[{value:"none",label:"なし（単群・記述的・実態調査など）"},{value:"2groups",label:"2群（ばく露 vs 非ばく露 / 介入 vs 対照 等）"},{value:"3groups",label:"3群以上"},{value:"prepost",label:"前後比較（同一対象への1つの介入前後など）"},{value:"repeated",label:"反復測定・クロスオーバー（同一対象に対する複数の条件・姿勢・時間での測定など）"},{value:"other",label:"その他"}];function st(e){const t=a.get("data");e.innerHTML=`
    <div class="fade-in">
      ...
      <div class="card card-highlight" id="dataSummaryPreview">
        ...
        <div id="dataSummaryContent">${$e(t)}</div>
      </div>
    </div>
  `,e.querySelectorAll('#dataTypeGroup input[type="checkbox"]').forEach(i=>{i.addEventListener("change",()=>{const n=Array.from(e.querySelectorAll("#dataTypeGroup input:checked")).map(l=>l.value);a.set("data.types",n),e.querySelectorAll("#dataTypeGroup .checkbox-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#typeOtherWrapper");if(o&&(o.style.display=n.includes("other")?"block":"none",!n.includes("other"))){a.set("data.typeOtherText","");const l=e.querySelector("#typeOtherText");l&&(l.value="")}I()})});const s=e.querySelector("#typeOtherText");s&&s.addEventListener("input",i=>{a.set("data.typeOtherText",i.target.value),I()}),e.querySelector("#sampleSize").addEventListener("input",i=>{a.set("data.sampleSize",i.target.value),I()}),e.querySelectorAll('input[name="grouping"]').forEach(i=>{i.addEventListener("change",n=>{a.set("data.grouping",n.target.value),e.querySelectorAll("#groupingGroup .radio-item").forEach(l=>{l.classList.toggle("checked",l.querySelector("input").checked)});const o=e.querySelector("#groupingOtherWrapper");if(o&&(o.style.display=n.target.value==="other"?"block":"none",n.target.value!=="other")){a.set("data.groupingOtherText","");const l=e.querySelector("#groupingOtherText");l&&(l.value="")}I()})});const r=e.querySelector("#groupingOtherText");r&&r.addEventListener("input",i=>{a.set("data.groupingOtherText",i.target.value),I()})}function I(){const e=a.get("data"),t=document.querySelector("#dataSummaryContent");t&&(t.innerHTML=$e(e));const s=document.querySelector("#sumData");if(s){const r=e.types||[];if(r.length>0){const i=r.map(n=>{var o;return((o=Y.find(l=>l.id===n))==null?void 0:o.label.split("（")[0])||n});s.textContent=i.join("、"),s.classList.add("active")}}}function $e(e){var r;const t=(e.types||[]).map(i=>Y.find(n=>n.id===i));let s=((r=Se.find(i=>i.value===e.grouping))==null?void 0:r.label)||"未選択";return e.grouping==="other"&&e.groupingOtherText&&(s+=`（${ve(e.groupingOtherText)}）`),t.length===0&&!e.sampleSize&&!e.grouping?'<p style="color: var(--color-text-muted);">データを選択すると、ここに概要が表示されます。</p>':`
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-4);">
      <div>
        <strong>データタイプ（${t.length}種類）</strong>
        <ul style="margin-top: var(--space-2); padding-left: var(--space-5);">
          ${t.map(i=>{if(!i)return"";let n=i.label;return i.id==="other"&&e.typeOtherText&&(n+=`（${ve(e.typeOtherText)}）`),`<li>${i.icon} ${n}</li>`}).join("")||'<li style="color: var(--color-text-muted);">未選択</li>'}
        </ul>
      </div>
      <div>
  ...
  `}function it(){const e=a.get("data");return(e.types||[]).length>0&&e.grouping}function ve(e){return e?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}const fe={"2groups":{continuous:{normal:"t検定（独立2群）",nonNormal:"Mann-Whitney U検定"},categorical:"χ²検定 / Fisher正確確率検定"},"3groups":{continuous:{normal:"一元配置分散分析（ANOVA）",nonNormal:"Kruskal-Wallis検定"},categorical:"χ²検定"},prepost:{continuous:{normal:"対応のあるt検定",nonNormal:"Wilcoxon符号付順位和検定"},categorical:"McNemar検定"},none:{continuous:{normal:"記述統計、相関分析",nonNormal:"Spearman順位相関"},categorical:"度数分布、記述統計"}};function nt(e){const t=a.get("analysis"),s=a.get("data");e.innerHTML=`
    <div class="fade-in">
      ...
      <div id="step6Results">
        ${t.aiResult?U(t.aiResult):""}
      </div>
    </div>
  `,e.querySelector("#btnAnalysis").addEventListener("click",at)}function rt(e){var d,u;const t=e.grouping||"none",s=e.types||[],r=fe[t]||fe.none,i=s.some(p=>["vitals","labs","scales"].includes(p)),n=s.some(p=>["attributes","intervention"].includes(p)),o=s.includes("timeseries"),l=s.some(p=>["interview","observation"].includes(p)),c=[];return i&&c.push(`<li><strong>連続変数の群比較:</strong> ${((d=r.continuous)==null?void 0:d.normal)||r.continuous||"記述統計"}（正規分布を仮定）/ ${((u=r.continuous)==null?void 0:u.nonNormal)||"非パラメトリック検定"}（正規分布でない場合）</li>`),n&&c.push(`<li><strong>カテゴリ変数:</strong> ${r.categorical}</li>`),o&&c.push("<li><strong>時系列分析:</strong> 線形混合モデル（Linear Mixed Model）/ 反復測定分散分析</li>"),l&&c.push("<li><strong>質的データ:</strong> 質的内容分析 / テーマ分析 / グラウンデッドセオリー</li>"),e.sampleSize&&parseInt(e.sampleSize)<30&&c.push('<li style="color: var(--color-warning);"><strong>⚠️ 注意:</strong> サンプルサイズが30未満のため、ノンパラメトリック検定の使用を推奨します</li>'),c.length===0?'<p style="color: var(--color-text-muted);">Step 5でデータを選択すると、自動提案が表示されます。</p>':`<ul style="padding-left: var(--space-5);">${c.join("")}</ul>`}function at(){var n;const e=a.get("data"),s=`
研究デザイン: ${a.get("rq.selectedDesign")||""}
データタイプ: ${(e.types||[]).join(", ")}
サンプルサイズ: ${e.sampleSize||"未定"}
群分け: ${e.grouping||"未定"}
  `.trim(),r=`${k.statisticsProposal}

---

${s}`;if(M()){const o=JSON.parse(L.statisticsProposal);a.set("analysis.aiResult",o),document.querySelector("#step6Results").innerHTML=U(o);const l=document.querySelector("#sumAnalysis");l&&(l.textContent=((n=o.primaryAnalysis)==null?void 0:n.method)||"提案済み",l.classList.add("active"));return}const i=document.querySelector("#step6Results");i.innerHTML=E({prompt:r,containerId:"geminiAnalysis",label:"統計分析手法の提案",expectJson:!1,placeholder:"Geminiが出力した「📋 分析方法提案」をここにコピー＆ペーストしてください..."}),T(i,r,(o,l)=>{var u;const c=l||o||"";let d=null;try{const m=c.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim().match(/\{[\s\S]*"primaryAnalysis"[\s\S]*\}/);m&&(d=JSON.parse(m[0]))}catch{}if(d||(d=ot(c)),d){a.set("analysis.aiResult",d),i.innerHTML=U(d);const p=document.querySelector("#sumAnalysis");p&&(p.textContent=((u=d.primaryAnalysis)==null?void 0:u.method)||"提案済み",p.classList.add("active"))}else alert("提案内容を判読できませんでした。Geminiが出力した「📋 分析方法提案」をそのまま貼り付けてください。")})}function ot(e){e=e.replace(/\*\*(.+?)\*\*/g,"$1").replace(/^[-•]\s*/gm,"").replace(/^\d+\.\s*/gm,"");const t={primaryAnalysis:{method:"",reason:""},secondaryAnalyses:[],effectSize:"",multivariateNeeded:!1,multivariateMethod:"",sampleSizeNote:""},s=e.match(/主解析\s*[:：]\s*(.+?)(?:\n|$)/);s&&(t.primaryAnalysis.method=s[1].trim());const r=e.match(/主解析の理由\s*[:：]\s*([\s\S]*?)(?=(?:副解析|効果量|多変量|サンプル|---|✅|📌|$))/);r&&(t.primaryAnalysis.reason=r[1].trim());const i=e.match(/副解析\s*[:：]\s*(.+?)(?:\n|$)/);if(i&&i[1].trim()){const c=e.match(/副解析の理由\s*[:：]\s*([\s\S]*?)(?=(?:効果量|多変量|サンプル|---|✅|📌|$))/);t.secondaryAnalyses.push({method:i[1].trim(),reason:c?c[1].trim():""})}const n=e.match(/効果量\s*[:：]\s*([\s\S]*?)(?=(?:多変量|サンプル|---|✅|📌|$))/);n&&(t.effectSize=n[1].trim());const o=e.match(/多変量解析\s*[:：]\s*([\s\S]*?)(?=(?:サンプル|---|✅|📌|$))/);if(o){const c=o[1].trim();(c.includes("必要")||c.includes("要"))&&(t.multivariateNeeded=!0,t.multivariateMethod=c.replace(/必要[。、．]?\s*/,"").trim())}const l=e.match(/サンプルサイズ概算\s*[:：]\s*([\s\S]*?)(?=(?:---|✅|📌|$))/);return l&&(t.sampleSizeNote=l[1].trim()),t.primaryAnalysis.method?t:e.trim().length>30?(t.primaryAnalysis.method=e.trim().split(`
`)[0].substring(0,100),t.primaryAnalysis.reason=e.trim(),t):null}function U(e){var t;return`
    <div class="ai-response">
  ...
  `}function lt(){return!!a.get("analysis.aiResult")}function ct(e){const t=a.get("proposal");e.innerHTML=`
    <div class="fade-in">
  ...
  `,e.querySelector("#btnGenerate").addEventListener("click",pt),t.draft&&K(t.draft)}function dt(){var o,l;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review");a.get("data");const i=a.get("analysis"),n=e.refinedResult;return`
    <div>
    ...
    `}function pt(){var b,C,A,X,Z,ee,te,se,ie,ne,re,ae,oe,le,ce,de;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review"),i=a.get("data"),n=a.get("analysis"),o=s.selected||"",l=s.notes||{},c=z[o]||[];let d="";if(c.length>0){const v=[];c.forEach((qe,ke)=>{const _=l[ke];_&&_.trim()&&v.push(`  ✓ ${qe}: ${_.trim()}`)}),v.length>0&&(d=`
...
…（以下省略。全体の骨格は上記を参考に執筆してください）`);const p=((A=(C=n.aiResult)==null?void 0:C.primaryAnalysis)==null?void 0:A.method)||"未提案",m=(((Z=(X=n.aiResult)==null?void 0:X.primaryAnalysis)==null?void 0:Z.reason)||"").substring(0,200),g=(((ee=n.aiResult)==null?void 0:ee.secondaryAnalyses)||[]).map(v=>v.method).filter(Boolean).join(", "),y=`
...
【研究テーマ】
${((te=e.refinedResult)==null?void 0:te.theme)||((se=e.refinedResult)==null?void 0:se.title)||"未設定"}

【リサーチクエスチョン】
${((ie=e.refinedResult)==null?void 0:ie.rq)||e.question||"未設定"}

【研究デザイン】
${t.selectedDesign||"未選択"}

【研究の骨子】
対象: ${((ne=e.refinedResult)==null?void 0:ne.target)||"未整理"}
ゴール: ${((re=e.refinedResult)==null?void 0:re.goal)||"未整理"}
アプローチ: ${(((ae=e.refinedResult)==null?void 0:ae.approaches)||[]).map(v=>`${v.name}: ${v.description}`).join(`
`)||"なし"}
...
理由: ${m}
${g?`副解析: ${g}`:""}
効果量: ${((oe=n.aiResult)==null?void 0:oe.effectSize)||"未決定"}
多変量解析: ${(le=n.aiResult)!=null&&le.multivariateNeeded?(ce=n.aiResult)==null?void 0:ce.multivariateMethod:"不要"}
サンプルサイズ根拠: ${((de=n.aiResult)==null?void 0:de.sampleSizeNote)||"未算出"}

━━━ 補足情報 ━━━

【文献レビュー概要（論理構成案）】
${u||"未実施"}
  `.trim(),S=`${k.proposalDraft}

---

${y}`;if(M()){const v=L.proposalDraft;a.set("proposal.draft",v),document.querySelector("#step7Results").innerHTML=F(v),K(v);return}const h=document.querySelector("#step7Results");h.innerHTML=E({prompt:S,containerId:"geminiProposal",label:"研究計画書草案の生成",expectJson:!1,placeholder:"Geminiからの研究計画書草案をここに貼り付けてください..."}),T(h,S,v=>{v&&(a.set("proposal.draft",v),h.innerHTML=F(v),K(v))})}function ut(e){const t="display:inline-block;background:#fff3cd;color:#856404;font-size:0.7rem;padding:1px 6px;border-radius:3px;margin-left:4px;font-weight:bold;vertical-align:middle;border:1px solid #f0c36d;",s={lit:`<span style="${t}" title="文献を自身で検索し、実在を確認してください">⚠️文献要確認</span>`,stat:`<span style="${t}" title="統計の専門家に妥当性を確認してください">⚠️統計要確認</span>`,sample:`<span style="${t}" title="サンプルサイズの計算根拠を自身で検証してください">⚠️要検証</span>`,ethics:`<span style="${t}" title="施設の倫理審査要件に合わせて修正してください">⚠️施設に合わせて修正</span>`,citation:`<span style="${t}background:#f8d7da;color:#721c24;border-color:#f5c6cb;" title="実在する文献に差し替えてください">🔴出典未確認</span>`};let r=0;const i=n=>(r++,n);return e=e.replace(/出典確認中/g,()=>i(`出典確認中 ${s.citation}`)),e=e.replace(/(先行研究によ(?:れば|ると))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/(既存の(?:エビデンス|研究|知見)(?:では|によ(?:れば|ると)))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/((?:国内外の|複数の|多くの|近年の)(?:研究|報告|調査)(?:では|で|が|において))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/((?:メタアナリシス|システマティックレビュー)(?:では|によ(?:れば|ると)))/g,n=>i(`${n} ${s.lit}`)),e=e.replace(/(t検定|χ²検定|カイ二乗検定|Mann-Whitney|Wilcoxon|ANOVA|分散分析|ロジスティック回帰|Cox比例ハザード|Kaplan-Meier|ログランク検定|線形混合モデル|共分散分析|因子分析|主成分分析|構造方程式)/g,n=>i(`${n} ${s.stat}`)),e=e.replace(/((?:サンプルサイズ|標本サイズ|症例数)(?:は|を|の)[^<]{5,60}?(?:名|例|人|とする|と設定|を目標))/g,n=>i(`${n} ${s.sample}`)),e=e.replace(/(インフォームド・コンセント)/g,n=>i(`${n} ${s.ethics}`)),e=e.replace(/(倫理審査委員会(?:の承認|に申請|の審査))/g,n=>i(`${n} ${s.ethics}`)),{html:e,count:r,tags:s}}function F(e){let t=e.replace(/^# (.+)$/gm,'<h2 style="margin-top: var(--space-6); color: var(--color-primary-dark); border-bottom: 2px solid var(--color-primary-border); padding-bottom: var(--space-2);">$1</h2>').replace(/^## (.+)$/gm,'<h3 style="margin-top: var(--space-5); color: var(--color-text);">$1</h3>').replace(/^### (.+)$/gm,'<h4 style="margin-top: var(--space-4); color: var(--color-text-secondary);">$1</h4>').replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/^- (.+)$/gm,"<li>$1</li>").replace(/\n\n/g,"</p><p>").replace(/\n/g,"<br>");const{html:s,count:r,tags:i}=ut(t);return t=s,`
    <div class="ai-response">
  ...
  `}function K(e){const t=document.querySelector("#btnCopyProposal");t&&t.addEventListener("click",()=>{navigator.clipboard.writeText(e).then(()=>{t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)}).catch(()=>{const i=document.createElement("textarea");i.value=e,document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),t.textContent="✅ コピーしました",setTimeout(()=>{t.textContent="📋 テキストをコピー"},2e3)})});const s=document.querySelector("#btnDownloadWord");s&&s.addEventListener("click",()=>{mt(e)});const r=document.querySelector("#btnDownloadPDF");r&&r.addEventListener("click",()=>{gt(e)})}function mt(e){var l,c,d,u;const s=`
<!DOCTYPE html>
...
<body>
  ${t}
...
</html>`),s.document.close(),setTimeout(()=>{s.print()},500)}function vt(){return!!a.get("proposal.draft")}const ft=[{id:1,render:Oe,validate:Pe},{id:2,render:He,validate:Qe},{id:3,render:Be,validate:We},{id:4,render:Ve,validate:et},{id:5,render:st,validate:it},{id:6,render:nt,validate:lt},{id:7,render:ct,validate:vt}],yt=document.getElementById("stepContent"),ht=document.getElementById("progressFill"),xe=document.querySelectorAll(".step-tab"),we=document.getElementById("btnPrev"),R=document.getElementById("btnNext"),bt=document.getElementById("stepIndicator"),q=document.getElementById("settingsModal");let f=a.get("currentStep")||1,ye=!1;function Re(){ye||(ye=!0,a.hasSavedData()&&qt(),P(),H(),Rt(),xt(),wt(),kt(),V())}function P(){const e=ft.find(t=>t.id===f);e&&e.render(yt)}const St={1:{label:"種と整理",affects:[2,4,6,7],dataKeys:["seed.refinedResult"]},2:{label:"デザイン案",affects:[3,4,6,7],dataKeys:["rq.selectedDesign","rq.aiResults"]},3:{label:"ガイドライン",affects:[4,7],dataKeys:["guideline.selected"]},4:{label:"文献レビュー",affects:[7],dataKeys:["review.aiResult"]},5:{label:"データ収集",affects:[6,7],dataKeys:["data.types","data.sampleSize"]},6:{label:"分析方法",affects:[7],dataKeys:["analysis.aiResult"]}},he={1:"種と整理",2:"デザイン案",3:"ガイドライン",4:"文献レビュー",5:"データ収集",6:"分析方法",7:"計画書草案"};function W(e){if(!(e<1||e>7)){if(e<f){const t=St[e];if(t){const s=t.affects.filter(r=>r===2?!!a.get("rq.aiResults"):r===3?!!a.get("guideline.selected"):r===4?!!a.get("review.aiResult"):r===6?!!a.get("analysis.aiResult"):r===7?!!a.get("proposal.draft"):!1);s.length>0&&$t(e,s)}}f=e,a.set("currentStep",f),P(),H(),window.scrollTo({top:0,behavior:"smooth"})}}function $t(e,t){const s=t.map(n=>`Step ${n}（${he[n]}）`).join("、"),r=document.getElementById("staleDataWarning");r&&r.remove();const i=document.createElement("div");i.id="staleDataWarning",i.style.cssText="position:fixed;top:0;left:0;right:0;z-index:9999;background:linear-gradient(135deg,#fff3cd,#ffeeba);border-bottom:2px solid #f0c36d;padding:12px 20px;display:flex;align-items:center;gap:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1);",i.innerHTML=`
      <span style="font-size:1.3rem;">🔄</span>
      <div style="flex:1;color:#856404;font-size:0.9rem;">
        <strong>Step ${e}（${he[e]}）を修正すると、${s} の内容が古くなる可能性があります。</strong><br>
    ...
    `,document.body.prepend(i),setTimeout(()=>{i.parentElement&&i.remove()},1e4)}function H(){const e=f/7*100;ht.style.width=`${e}%`,xe.forEach(t=>{const s=parseInt(t.dataset.step);t.classList.toggle("active",s===f),t.classList.toggle("completed",a.get("completedSteps").has(s))}),we.disabled=f===1,f===7?(R.innerHTML="✅ 完了",R.classList.remove("btn-primary"),R.classList.add("btn-success")):(R.innerHTML=`
      確認して次へ
    ...
    `,R.classList.remove("btn-success"),R.classList.add("btn-primary")),bt.textContent=`Step ${f} / 7`}function xt(){xe.forEach(e=>{e.addEventListener("click",()=>{const t=parseInt(e.dataset.step);W(t)})})}function wt(){we.addEventListener("click",()=>{W(f-1)}),R.addEventListener("click",()=>{const e=a.get("completedSteps");e.add(f),a.set("completedSteps",e),f<7&&W(f+1)})}function Rt(){const e=document.getElementById("btnSettings"),t=document.getElementById("btnCloseSettings"),s=document.getElementById("btnSaveSettings"),r=document.getElementById("demoModeToggle");r.checked=a.get("demoMode"),e.addEventListener("click",()=>{q.classList.add("visible")}),t.addEventListener("click",()=>{q.classList.remove("visible")}),q.addEventListener("click",i=>{i.target===q&&q.classList.remove("visible")}),s.addEventListener("click",()=>{a.saveDemoMode(r.checked),q.classList.remove("visible"),s.textContent="✅ 保存しました",setTimeout(()=>{s.textContent="保存"},1500)})}function V(){var o,l,c,d,u,p;const e=a.get("seed"),t=a.get("rq"),s=a.get("guideline"),r=a.get("review"),i=a.get("data"),n=a.get("analysis");((o=e.refinedResult)!=null&&o.theme||(l=e.refinedResult)!=null&&l.title||e.question)&&x("Theme",(((c=e.refinedResult)==null?void 0:c.theme)||((d=e.refinedResult)==null?void 0:d.title)||e.question).substring(0,60)),e.refinedResult&&x("RQ",e.refinedResult.rq||e.refinedResult.title),t.selectedDesign&&x("Design",t.selectedDesign),s.selected&&x("Guideline",s.selected),r.aiResult&&x("Literature","背景構築済み"),((u=i.types)==null?void 0:u.length)>0&&x("Data",`${i.types.length}種類のデータ`),(p=n.aiResult)!=null&&p.primaryAnalysis&&x("Analysis",n.aiResult.primaryAnalysis.method)}function x(e,t){const s=document.querySelector(`#sum${e}`);s&&(s.textContent=t,s.classList.add("active"))}function qt(){const e=document.createElement("div");e.className="modal-overlay visible",e.id="resumeDialog",e.innerHTML=`
    ...
    `,document.body.appendChild(e),document.getElementById("btnResume").addEventListener("click",()=>{a.loadFullState(),f=a.get("currentStep")||1,P(),H(),V(),e.remove()}),document.getElementById("btnNewProject").addEventListener("click",()=>{a.reset()})}function kt(){const e=document.getElementById("btnExport"),t=document.getElementById("btnImport"),s=document.getElementById("fileImport");e&&e.addEventListener("click",()=>{a.exportToJSON();const r=e.innerHTML;e.innerHTML="✅ 保存しました",setTimeout(()=>{e.innerHTML=r},2e3)}),t&&s&&(t.addEventListener("click",()=>{s.click()}),s.addEventListener("change",async r=>{const i=r.target.files[0];if(i){try{await a.importFromJSON(i),f=a.get("currentStep")||1,P(),H(),V();const n=t.innerHTML;t.innerHTML="✅ 読み込み完了",setTimeout(()=>{t.innerHTML=n},2e3)}catch(n){alert("ファイルの読み込みに失敗しました: "+n.message)}s.value=""}}))}document.addEventListener("DOMContentLoaded",Re);document.readyState!=="loading"&&Re();
